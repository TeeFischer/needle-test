...
export async function generateUnfurlImage(title, subtext, backgroundImage = "", targetPath) {
    throw new Error("unfurl image is currently not supported");
    // try {
    //     const { UltimateTextToImage, getCanvasImage } = await import("ultimate-text-to-image");
    ...
    //     const baseOptions: Partial<import("ultimate-text-to-image").IOptions> =
    //     {
    ...
    //     });
    //     const margin = 100;
    //     const unfurlImages: import("ultimate-text-to-image").IImage[] = [];
    //     if (backgroundImage) {
