import { BufferGeometry as J, Mesh as q, Box3 as ge, Vector3 as A, Sphere as Oe, CompressedTexture as Ge, Texture as E, Matrix3 as Fe, InterleavedBuffer as We, InterleavedBufferAttribute as Ue, BufferAttribute as ze, TextureLoader as Ee, Matrix4 as _e, Clock as Ne, MeshStandardMaterial as qe } from "./three-CJSAehtG.js";
import { DRACOLoader as Ve, KTX2Loader as Xe, MeshoptDecoder as je, GLTFLoader as xe } from "./three-examples-Doq0rvFU.js";
const Ke = "";
...
class Le {
  ...
  async load(t, e) {
    ...
    n || (this._webglRenderer ??= (async () => {
      const { WebGLRenderer: u } = await import("./three-CJSAehtG.js").then((d) => d.THREE);
      return new u();
