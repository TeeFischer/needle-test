 ...
 * @license Zlib
 */
var tr = "6.37.8", ir = class {
  /**
   * Frees internal resources.
   */
  dispose() {
  }
}, nt = 1 / 1e3, rr = 1e3, ei = class {
  /**
  ...
  const e = new Float32Array([-1, -1, 0, 3, -1, 0, -1, 3, 0]), t = new Float32Array([0, 0, 2, 0, 0, 2]), i = new $t();
  return i.setAttribute("position", new qe(e, 3)), i.setAttribute("uv", new qe(t, 2)), i;
})(), H = class pt {
  /**
   ...
   */
  constructor(t = "Pass", i = new dt(), r = new Wi()) {
  ...
  set fullscreenMaterial(t) {
    let i = this.screen;
    i !== null ? i.material = t : (i = new Jt(pt.fullscreenGeometry, t), i.frustumCulled = !1, this.scene === null && (this.scene = new dt()), this.scene.add(i), this.screen = i);
  }
  /**
  ...
  dispose() {
    for (const t of Object.keys(this)) {
      const i = this[t];
      (i instanceof T || i instanceof _t || i instanceof Je || i instanceof pt) && this[t].dispose();
    }
...
#include <dithering_fragment>
}`, ce = "varying vec2 vUv;void main(){vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", He = class extends w {
  /**
   ...
   */
  constructor(e, t = !0) {
    super("CopyPass"), this.fullscreenMaterial = new He(), this.needsSwap = !1, this.renderTarget = e, e === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: R,
      magFilter: R,
      stencilBuffer: !1,
      depthBuffer: !1
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && (this.renderTarget.texture.type = i, i !== Y ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === y && (this.renderTarget.texture.colorSpace = y));
  }
}, bt = /* @__PURE__ */ new N(), me = class extends H {
  /**
   ...
   */
  render(e, t, i, r, a) {
    const n = this.overrideClearColor, s = this.overrideClearAlpha, o = e.getClearAlpha(), l = n !== null, u = s >= 0;
    l ? (e.getClearColor(bt), e.setClearColor(n, u ? s : o)) : u && e.setClearAlpha(s), e.setRenderTarget(this.renderToScreen ? null : t), e.clear(this.color, this.depth, this.stencil), l ? e.setClearColor(bt, o) : u && e.setClearAlpha(o);
  }
}, ii = class extends H {
  /**
   ...
   */
  constructor(e, t) {
    super("MaskPass", e, t), this.needsSwap = !1, this.clearPass = new me(!1, !1, !0), this.inverse = !1;
  }
  set mainScene(e) {
    this.scene = e;
  }
   ...
   */
  render(e, t, i, r, a) {
    const n = e.getContext(), s = e.state.buffers, o = this.scene, l = this.camera, u = this.clearPass, f = this.inverted ? 0 : 1, h = 1 - f;
    s.color.setMask(!1), s.depth.setMask(!1), s.color.setLocked(!0), s.depth.setLocked(!0), s.stencil.setTest(!0), s.stencil.setOp(n.REPLACE, n.REPLACE, n.REPLACE), s.stencil.setFunc(n.ALWAYS, f, 4294967295), s.stencil.setClear(h), s.stencil.setLocked(!0), this.clearPass.enabled && (this.renderToScreen ? u.render(e, null) : (u.render(e, t), u.render(e, i))), this.renderToScreen ? (e.setRenderTarget(null), e.render(o, l)) : (e.setRenderTarget(t), e.render(o, l), e.setRenderTarget(i), e.render(o, l)), s.color.setLocked(!1), s.depth.setLocked(!1), s.stencil.setLocked(!1), s.stencil.setFunc(n.EQUAL, 1, 4294967295), s.stencil.setOp(n.KEEP, n.KEEP, n.KEEP), s.stencil.setLocked(!0);
  }
}, nr = class {
  /**
  ...
  constructor(e = null, {
    ...
    this.renderer = null, this.inputBuffer = this.createBuffer(t, i, a, r), this.outputBuffer = this.inputBuffer.clone(), this.copyPass = new _e(), this.depthTexture = null, this.passes = [], this.timer = new ei(), this.autoRenderToScreen = !0, this.setRenderer(e);
  }
  /**
  ...
  setRenderer(e) {
    if (this.renderer = e, e !== null) {
      ...
      r === Y && e.outputColorSpace === y && (this.inputBuffer.texture.colorSpace = y, this.outputBuffer.texture.colorSpace = y, this.inputBuffer.dispose(), this.outputBuffer.dispose()), e.autoClear = !1, this.setSize(t.width, t.height);
   ...
   */
  createDepthTexture() {
    const e = this.depthTexture = new Me();
  ...
  createBuffer(e, t, i, r) {
    const a = this.renderer, n = a === null ? new p() : a.getDrawingBufferSize(new p()), s = {
      ...
      depthBuffer: e,
      type: i
    }, o = new T(n.width, n.height, s);
    return r > 0 && (o.ignoreDepthForMultisampleCopy = !1, o.samples = r), i === Y && a !== null && a.outputColorSpace === y && (o.texture.colorSpace = y), o.texture.name = "EffectComposer.Buffer", o.texture.generateMipmaps = !1, o;
  }
  /**
  ...
  render(e) {
    ...
    for (const u of this.passes)
      u.enabled && (u.render(t, r, a, e, n), u.needsSwap && (n && (i.renderToScreen = u.renderToScreen, s = t.getContext(), o = t.state.buffers.stencil, o.setFunc(s.NOTEQUAL, 1, 4294967295), i.render(t, r, a, e, n), o.setFunc(s.EQUAL, 1, 4294967295)), l = r, r = a, a = l), u instanceof ii ? n = !0 : u instanceof ti && (n = !1));
  }
  /**
  ...
  dispose() {
    for (const e of this.passes)
      e.dispose();
    this.passes = [], this.inputBuffer !== null && this.inputBuffer.dispose(), this.outputBuffer !== null && this.outputBuffer.dispose(), this.deleteDepthTexture(), this.copyPass.dispose(), this.timer.dispose(), H.fullscreenGeometry.dispose();
  }
}, V = {
  NONE: 0,
  DEPTH: 1,
...
var ai = class {
  ...
  generate(e, t) {
    ...
    const i = e + t * 2, r = t > 0 ? Ut(i).slice(t, -t) : Ut(i), a = Math.floor((r.length - 1) / 2), n = r.reduce((h, d) => h + d, 0), s = r.slice(a), o = [...Array(a + 1).keys()], l = new Float64Array(Math.floor(o.length / 2)), u = new Float64Array(l.length);
    l[0] = s[0] / n;
    for (let h = 1, d = 1, v = o.length - 1; h < v; h += 2, ++d) {
      const A = o[h], m = o[h + 1], S = s[h], C = s[h + 1], E = S + C, D = (A * S + m * C) / E;
      l[d] = E / n, u[d] = D;
    }
    ...
    if (f !== 0)
      for (let h = 0, d = l.length, v = 1 / f; h < d; ++h)
        l[h] *= v;
    this.offsets = o, this.weights = s, this.linearOffsets = u, this.linearWeights = l;
  }
}, or = class {
  /**
  ...
  setMaterial(e) {
    if (this.disposeMaterials(), this.material = e, e !== null) {
      ...
      for (const i of t)
        i.uniforms = Object.assign({}, e.uniforms), i.side = Vi;
      t[2].skinning = !0, this.materialsBackSide = t.map((i) => {
        const r = this.cloneMaterial(i);
        return r.uniforms = Object.assign({}, e.uniforms), r.side = ke, r;
        ...
        const r = this.cloneMaterial(i);
        return r.uniforms = Object.assign({}, e.uniforms), r.flatShading = !0, r.side = ke, r;
  ...
  SUBTRACT: 31,
  VIVID_LIGHT: 32
}, fr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb+y.rgb,y.a),opacity);}", hr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,y,y.a*opacity);}", dr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4((x.rgb+y.rgb)*0.5,y.a),opacity);}", vr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(yHSL.xy,xHSL.z));return mix(x,vec4(z,y.a),opacity);}", pr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb,b=y.rgb;vec3 z=mix(step(0.0,b)*(1.0-min(vec3(1.0),(1.0-a)/b)),vec3(1.0),step(1.0,a));return mix(x,vec4(z,y.a),opacity);}", gr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb,b=y.rgb;vec3 z=step(0.0,a)*mix(min(vec3(1.0),a/max(1.0-b,1e-9)),vec3(1.0),step(1.0,b));return mix(x,vec4(z,y.a),opacity);}", mr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(min(x.rgb,y.rgb),y.a),opacity);}", Ar = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(abs(x.rgb-y.rgb),y.a),opacity);}", xr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb/max(y.rgb,1e-12),y.a),opacity);}", Dr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4((x.rgb+y.rgb-2.0*x.rgb*y.rgb),y.a),opacity);}", wr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=min(x.rgb,1.0);vec3 b=min(y.rgb,1.0);vec3 z=mix(2.0*a*b,1.0-2.0*(1.0-a)*(1.0-b),step(0.5,b));return mix(x,vec4(z,y.a),opacity);}", Tr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(step(1.0,x.rgb+y.rgb),y.a),opacity);}", Er = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(yHSL.x,xHSL.yz));return mix(x,vec4(z,y.a),opacity);}", Sr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(1.0-y.rgb,y.a),opacity);}", Cr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(y.rgb*(1.0-x.rgb),y.a),opacity);}", yr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(max(x.rgb,y.rgb),y.a),opacity);}", Mr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(clamp(y.rgb+x.rgb-1.0,0.0,1.0),y.a),opacity);}", Br = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(min(x.rgb+y.rgb,1.0),y.a),opacity);}", Pr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(clamp(2.0*y.rgb+x.rgb-1.0,0.0,1.0),y.a),opacity);}", Ir = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(xHSL.xy,yHSL.z));return mix(x,vec4(z,y.a),opacity);}", Rr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb*y.rgb,y.a),opacity);}", br = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(1.0-abs(1.0-x.rgb-y.rgb),y.a),opacity);}", Ur = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,y,opacity);}", Fr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(2.0*y.rgb*x.rgb,1.0-2.0*(1.0-y.rgb)*(1.0-x.rgb),step(0.5,x.rgb));return mix(x,vec4(z,y.a),opacity);}", Lr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 y2=2.0*y.rgb;vec3 z=mix(mix(y2,x.rgb,step(0.5*x.rgb,y.rgb)),max(y2-1.0,vec3(0.0)),step(x.rgb,y2-1.0));return mix(x,vec4(z,y.a),opacity);}", Or = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(min(x.rgb*x.rgb/max(1.0-y.rgb,1e-12),1.0),y.rgb,step(1.0,y.rgb));return mix(x,vec4(z,y.a),opacity);}", Nr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 xHSL=RGBToHSL(x.rgb);vec3 yHSL=RGBToHSL(y.rgb);vec3 z=HSLToRGB(vec3(xHSL.x,yHSL.y,xHSL.z));return mix(x,vec4(z,y.a),opacity);}", Hr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(x.rgb+y.rgb-min(x.rgb*y.rgb,1.0),y.a),opacity);}", zr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 a=x.rgb;vec3 b=y.rgb;vec3 y2=2.0*b;vec3 w=step(0.5,b);vec3 c=a-(1.0-y2)*a*(1.0-a);vec3 d=mix(a+(y2-1.0)*(sqrt(a)-a),a+(y2-1.0)*a*((16.0*a-12.0)*a+3.0),w*(1.0-step(0.25,a)));vec3 z=mix(c,d,w);return mix(x,vec4(z,y.a),opacity);}", Gr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return y;}", kr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){return mix(x,vec4(max(x.rgb+y.rgb-1.0,0.0),y.a),opacity);}", Qr = "vec4 blend(const in vec4 x,const in vec4 y,const in float opacity){vec3 z=mix(max(1.0-min((1.0-x.rgb)/(2.0*y.rgb),1.0),0.0),min(x.rgb/(2.0*(1.0-y.rgb)),1.0),step(0.5,y.rgb));return mix(x,vec4(z,y.a),opacity);}", Vr = /* @__PURE__ */ new Map([
  [g.ADD, fr],
  [g.ALPHA, hr],
  [g.AVERAGE, dr],
  [g.COLOR, vr],
  ...
  constructor({
    ...
    const n = this.image;
    n.width = n.height = r;
    const s = n.getContext("2d"), o = r / a;
    s.font = `${i}px ${t}`, s.textAlign = "center", s.textBaseline = "middle", s.fillStyle = "#ffffff";
    for (let l = 0, u = e.length; l < u; ++l) {
      const f = e[l], h = l % a, d = Math.floor(l / a);
      s.fillText(f, h * o + o / 2, d * o + o / 2);
    }
    this.characterCount = e.length, this.cellCount = a;
  }
}, I = class extends Tt {
  /**
  ...
  constructor(e, t, {
    ...
    super(), this.name = e, this.renderer = null, this.attributes = i, this.fragmentShader = t, this.vertexShader = o, this.defines = a, this.uniforms = n, this.extensions = s, this.blendMode = new si(r), this.blendMode.addEventListener("change", (l) => this.setChanged()), this._inputColorSpace = je, this._outputColorSpace = tt;
  }
  /**
  ...
  dispose() {
    for (const e of Object.keys(this)) {
      const t = this[e];
      (t instanceof T || t instanceof _t || t instanceof Je || t instanceof H) && this[e].dispose();
    }
  }
...
#include <colorspace_fragment>
   ...
   */
  constructor({
    kernelSize: e = te.MEDIUM,
    resolutionScale: t = 0.5,
    width: i = x.AUTO_SIZE,
    height: r = x.AUTO_SIZE,
    resolutionX: a = i,
    resolutionY: n = r
  } = {}) {
    ...
    const s = this.resolution = new x(this, a, n, t);
    s.addEventListener("change", (o) => this.setSize(s.baseWidth, s.baseHeight)), this._blurMaterial = new $e(), this._blurMaterial.kernelSize = e, this.copyMaterial = new He();
  }
  /**
   ...
   */
  render(e, t, i, r, a) {
    const n = this.scene, s = this.camera, o = this.renderTargetA, l = this.renderTargetB, u = this.blurMaterial, f = u.kernelSequence;
    let h = t;
    this.fullscreenMaterial = u;
    for (let d = 0, v = f.length; d < v; ++d) {
      const A = (d & 1) === 0 ? o : l;
      u.kernel = f[d], u.inputBuffer = h.texture, e.setRenderTarget(A), e.render(n, s), h = A;
    }
    this.fullscreenMaterial = this.copyMaterial, this.copyMaterial.inputBuffer = h.texture, e.setRenderTarget(this.renderToScreen ? null : i), e.render(n, s);
  }
  /**
   * Updates the size of this pass.
   *
  ...
  setSize(e, t) {
    ...
    this.renderTargetA.setSize(r, a), this.renderTargetB.setSize(r, a), this.blurMaterial.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, i) {
    i !== void 0 && (this.renderTargetA.texture.type = i, this.renderTargetB.texture.type = i, i !== Y ? (this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1", this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1") : e !== null && e.outputColorSpace === y && (this.renderTargetA.texture.colorSpace = y, this.renderTargetB.texture.colorSpace = y));
  }
  /**
   * An auto sizing flag.
   *
...
gl_FragColor=vec4(l*mask);
  ...
  constructor({
    ...
    resolutionScale: r = 1,
    width: a = x.AUTO_SIZE,
    height: n = x.AUTO_SIZE,
    resolutionX: s = a,
    resolutionY: o = n
  } = {}) {
    super("LuminancePass"), this.fullscreenMaterial = new oi(i, t), this.needsSwap = !1, this.renderTarget = e, this.renderTarget === void 0 && (this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "LuminancePass.Target");
    const l = this.resolution = new x(this, s, o, r);
...
#include <colorspace_fragment>
}`, $r = "uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;varying vec2 vUv6;varying vec2 vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+texelSize*vec2(-1.0,1.0);vUv1=vUv+texelSize*vec2(0.0,1.0);vUv2=vUv+texelSize*vec2(1.0,1.0);vUv3=vUv+texelSize*vec2(-1.0,0.0);vUv4=vUv+texelSize*vec2(1.0,0.0);vUv5=vUv+texelSize*vec2(-1.0,-1.0);vUv6=vUv+texelSize*vec2(0.0,-1.0);vUv7=vUv+texelSize*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}", ui = class extends w {
  /**
   ...
   */
  constructor() {
    super("MipmapBlurPass"), this.needsSwap = !1, this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "Upsampling.Mipmap0", this.downsamplingMipmaps = [], this.upsamplingMipmaps = [], this.downsamplingMaterial = new li(), this.upsamplingMaterial = new ui(), this.resolution = new p();
  }
  /**
  ...
  set levels(e) {
    if (this.levels !== e) {
      ...
      for (let i = 1, r = e - 1; i < r; ++i) {
        const a = t.clone();
        a.texture.name = "Upsampling.Mipmap" + i, this.upsamplingMipmaps.push(a);
      }
   ...
   */
  render(e, t, i, r, a) {
    const { scene: n, camera: s } = this, { downsamplingMaterial: o, upsamplingMaterial: l } = this, { downsamplingMipmaps: u, upsamplingMipmaps: f } = this;
    let h = t;
    this.fullscreenMaterial = o;
    for (let d = 0, v = u.length; d < v; ++d) {
      const A = u[d];
      o.setSize(h.width, h.height), o.inputBuffer = h.texture, e.setRenderTarget(A), e.render(n, s), h = A;
    }
    this.fullscreenMaterial = l;
    for (let d = f.length - 1; d >= 0; --d) {
      const v = f[d];
      l.setSize(h.width, h.height), l.inputBuffer = h.texture, l.supportBuffer = u[d].texture, e.setRenderTarget(v), e.render(n, s), h = v;
    }
  }
  /**
   * Updates the size of this pass.
  ...
  setSize(e, t) {
    ...
    for (let n = 0, s = this.downsamplingMipmaps.length; n < s; ++n)
      r = Math.round(r * 0.5), a = Math.round(a * 0.5), this.downsamplingMipmaps[n].setSize(r, a), n < this.upsamplingMipmaps.length && this.upsamplingMipmaps[n].setSize(r, a);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  initialize(e, t, i) {
    if (i !== void 0) {
      ...
      else if (e !== null && e.outputColorSpace === y)
        for (const a of r)
          a.texture.colorSpace = y;
    }
  }
  /**
   * Deletes internal render targets and textures.
...
#endif
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 texel=texture2D(map,uv);outputColor=vec4(texel.rgb*intensity,max(inputColor.a,texel.a));}`, fi = class extends I {
  /**
  ...
  constructor({
    ...
    radius: n = 0.85,
    levels: s = 8,
    kernelSize: o = te.LARGE,
    resolutionScale: l = 0.5,
    width: u = x.AUTO_SIZE,
    height: f = x.AUTO_SIZE,
    resolutionX: h = u,
    resolutionY: d = f
  } = {}) {
    ...
    }), this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "Bloom.Target", this.blurPass = new ge({ kernelSize: o }), this.luminancePass = new Ct({ colorOutput: !0 }), this.luminanceMaterial.threshold = t, this.luminanceMaterial.smoothing = i, this.mipmapBlurPass = new ci(), this.mipmapBlurPass.enabled = r, this.mipmapBlurPass.radius = n, this.mipmapBlurPass.levels = s, this.uniforms.get("map").value = r ? this.mipmapBlurPass.texture : this.renderTarget.texture;
    const v = this.resolution = new x(this, h, d, l);
   ...
   */
  update(e, t, i) {
    const r = this.renderTarget, a = this.luminancePass;
    a.enabled ? (a.render(e, t), this.mipmapBlurPass.enabled ? this.mipmapBlurPass.render(e, a.renderTarget) : this.blurPass.render(e, a.renderTarget, r)) : this.mipmapBlurPass.enabled ? this.mipmapBlurPass.render(e, t) : this.blurPass.render(e, t, r);
  }
  /**
   ...
   */
  initialize(e, t, i) {
    this.blurPass.initialize(e, t, i), this.luminancePass.initialize(e, t, i), this.mipmapBlurPass.initialize(e, t, i), i !== void 0 && (this.renderTarget.texture.type = i, e !== null && e.outputColorSpace === y && (this.renderTarget.texture.colorSpace = y));
  }
...
float focusNear=clamp(focus-dof,0.0,1.0);float focusFar=clamp(focus+dof,0.0,1.0);float low=step(linearDepth,focusNear);float high=step(focusFar,linearDepth);float factor=(linearDepth-focusNear)*low+(linearDepth-focusFar)*high;vec2 dofBlur=vec2(clamp(factor*aperture,-maxBlur,maxBlur));vec2 dofblur9=dofBlur*0.9;vec2 dofblur7=dofBlur*0.7;vec2 dofblur4=dofBlur*0.4;vec4 color=inputColor;color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofBlur);color+=texture2D(inputBuffer,uv+(vec2(0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.15,0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.37,0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(-0.37,-0.15)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.15,-0.37)*aspectCorrection)*dofblur9);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.40,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur7);color+=texture2D(inputBuffer,uv+(vec2(0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,-0.4)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.4,0.0)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(-0.29,-0.29)*aspectCorrection)*dofblur4);color+=texture2D(inputBuffer,uv+(vec2(0.0,0.4)*aspectCorrection)*dofblur4);outputColor=color/41.0;}`, ia = class extends I {
  ...
  constructor({
    ...
    super("BokehEffect", ta, {
      blendFunction: e,
      attributes: V.CONVOLUTION | V.DEPTH,
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new c(t)],
        ["dof", new c(i)],
        ["aperture", new c(r)],
...
vec4 maxValue=texture2D(inputBuffer,vUv);for(int i=0;i<8;++i){vec4 kernel=kernel16[i];vec2 uv=step*kernel.xy+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);uv=step*kernel.zw+vUv;maxValue=max(texture2D(inputBuffer,uv),maxValue);}gl_FragColor=maxValue;
  ...
  generateKernel() {
    ...
    let r = 0, a = 0;
    for (let n = 0, s = Math.sqrt(80); n < 80; ++n) {
      const o = n * e, l = Math.sqrt(n) / s, u = l * Math.cos(o), f = l * Math.sin(o);
      n % 5 === 0 ? (i[a++] = u, i[a++] = f) : (t[r++] = u, t[r++] = f);
    }
...
float linearDepth=depth;
#endif
float signedDistance=linearDepth-focusDistance;float magnitude=smoothstep(0.0,focusRange,abs(signedDistance));gl_FragColor.rg=magnitude*vec2(step(signedDistance,0.0),step(0.0,signedDistance));}`, hi = class extends w {
  /**
  ...
  get worldFocusDistance() {
    return -de(this.focusDistance, this.near, this.far);
  }
  set worldFocusDistance(e) {
    this.focusDistance = le(-e, this.near, this.far);
  }
  /**
   ...
   */
  get worldFocusRange() {
    return -de(this.focusRange, this.near, this.far);
  }
  set worldFocusRange(e) {
    this.focusRange = le(-e, this.near, this.far);
  }
  /**
  ...
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNear.value = e.near, this.uniforms.cameraFar.value = e.far, e instanceof Re ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0);
  }
...
gl_FragColor=mask*texture2D(inputBuffer,vUv);
  ...
  constructor(e = null) {
    super({
      ...
      fragmentShader: ga,
      vertexShader: ce
    }), this.colorChannel = he.RED, this.maskFunction = yt.DISCARD;
  }
  /**
   * The input buffer.
   *
   ...
   */
  set maskTexture(e) {
    this.uniforms.maskTexture.value = e, delete this.defines.MASK_PRECISION_HIGH, e.type !== Y && (this.defines.MASK_PRECISION_HIGH = "1"), this.needsUpdate = !0;
  }
  /**
...
#endif
vec4 result=inputColor*(1.0-cocNearFar.y)+colorFar;result=mix(result,colorNear,cocNearFar.x);outputColor=result;}`, Aa = class extends I {
  /**
  ...
  constructor(e, {
    ...
    }), this.camera = e, this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "DoF.Intermediate", this.renderTargetMasked = this.renderTarget.clone(), this.renderTargetMasked.texture.name = "DoF.Masked.Far", this.renderTargetNear = this.renderTarget.clone(), this.renderTargetNear.texture.name = "DoF.Bokeh.Near", this.uniforms.get("nearColorBuffer").value = this.renderTargetNear.texture, this.renderTargetFar = this.renderTarget.clone(), this.renderTargetFar.texture.name = "DoF.Bokeh.Far", this.uniforms.get("farColorBuffer").value = this.renderTargetFar.texture, this.renderTargetCoC = this.renderTarget.clone(), this.renderTargetCoC.texture.name = "DoF.CoC", this.uniforms.get("farCoCBuffer").value = this.renderTargetCoC.texture, this.renderTargetCoCBlurred = this.renderTargetCoC.clone(), this.renderTargetCoCBlurred.texture.name = "DoF.CoC.Blurred", this.uniforms.get("nearCoCBuffer").value = this.renderTargetCoCBlurred.texture, this.cocPass = new q(new hi(e));
    const v = this.cocMaterial;
    v.focusDistance = a, v.focusRange = s, i !== void 0 && (v.worldFocusDistance = i), r !== void 0 && (v.worldFocusRange = r), this.blurPass = new ge({ resolutionScale: l, resolutionX: h, resolutionY: d, kernelSize: te.MEDIUM }), this.maskPass = new q(new di(this.renderTargetCoC.texture));
    const A = this.maskPass.fullscreenMaterial;
    A.colorChannel = he.GREEN, this.maskFunction = yt.MULTIPLY_RGB, this.bokehNearBasePass = new q(new Le(!1, !0)), this.bokehNearBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehNearFillPass = new q(new Le(!0, !0)), this.bokehNearFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoCBlurred.texture, this.bokehFarBasePass = new q(new Le(!1, !1)), this.bokehFarBasePass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.bokehFarFillPass = new q(new Le(!0, !1)), this.bokehFarFillPass.fullscreenMaterial.cocBuffer = this.renderTargetCoC.texture, this.target = null;
    const m = this.resolution = new x(this, h, d, l);
    m.addEventListener("change", (S) => this.setSize(m.baseWidth, m.baseHeight)), this.bokehScale = o;
  }
  set mainCamera(e) {
   ...
   */
  update(e, t, i) {
    const r = this.renderTarget, a = this.renderTargetCoC, n = this.renderTargetCoCBlurred, s = this.renderTargetMasked;
    if (this.target !== null) {
      const o = this.calculateFocusDistance(this.target);
      this.cocMaterial.focusDistance = o;
    }
    this.cocPass.render(e, null, a), this.blurPass.render(e, a, n), this.maskPass.render(e, t, s), this.bokehFarBasePass.render(e, s, r), this.bokehFarFillPass.render(e, r, this.renderTargetFar), this.bokehNearBasePass.render(e, t, r), this.bokehNearFillPass.render(e, r, this.renderTargetNear);
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    i.setBaseSize(e, t);
    const r = i.width, a = i.height;
    this.cocPass.setSize(e, t), this.blurPass.setSize(e, t), this.maskPass.setSize(e, t), this.renderTargetFar.setSize(e, t), this.renderTargetCoC.setSize(e, t), this.renderTargetMasked.setSize(e, t), this.renderTarget.setSize(r, a), this.renderTargetNear.setSize(r, a), this.renderTargetCoCBlurred.setSize(r, a), this.bokehNearBasePass.fullscreenMaterial.setSize(e, t), this.bokehNearFillPass.fullscreenMaterial.setSize(e, t), this.bokehFarBasePass.fullscreenMaterial.setSize(e, t), this.bokehFarFillPass.fullscreenMaterial.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
   ...
   */
  initialize(e, t, i) {
    this.cocPass.initialize(e, t, i), this.maskPass.initialize(e, t, i), this.bokehNearBasePass.initialize(e, t, i), this.bokehNearFillPass.initialize(e, t, i), this.bokehFarBasePass.initialize(e, t, i), this.bokehFarFillPass.initialize(e, t, i), this.blurPass.initialize(e, t, Y), e.capabilities.logarithmicDepthBuffer && (this.cocPass.fullscreenMaterial.defines.LOG_DEPTH = "1"), i !== void 0 && (this.renderTarget.texture.type = i, this.renderTargetNear.texture.type = i, this.renderTargetFar.texture.type = i, this.renderTargetMasked.texture.type = i, e !== null && e.outputColorSpace === y && (this.renderTarget.texture.colorSpace = y, this.renderTargetNear.texture.colorSpace = y, this.renderTargetFar.texture.colorSpace = y, this.renderTargetMasked.texture.colorSpace = y));
  }
}, xa = "uniform vec2 angle;uniform float scale;float pattern(const in vec2 uv){vec2 point=scale*vec2(dot(angle.yx,vec2(uv.x,-uv.y)),dot(angle,uv));return(sin(point.x)*sin(point.y))*4.0;}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(inputColor.rgb*10.0-5.0+pattern(uv*resolution));outputColor=vec4(color,inputColor.a);}", Da = class extends I {
  /**
...
varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;vec4 fxaa(const in vec4 inputColor,const in vec2 uv){float lumaCenter=luminance(inputColor.rgb);float lumaDown=luminance(texture2D(inputBuffer,vUvDown).rgb);float lumaUp=luminance(texture2D(inputBuffer,vUvUp).rgb);float lumaLeft=luminance(texture2D(inputBuffer,vUvLeft).rgb);float lumaRight=luminance(texture2D(inputBuffer,vUvRight).rgb);float lumaMin=min(lumaCenter,min(min(lumaDown,lumaUp),min(lumaLeft,lumaRight)));float lumaMax=max(lumaCenter,max(max(lumaDown,lumaUp),max(lumaLeft,lumaRight)));float lumaRange=lumaMax-lumaMin;if(lumaRange<max(EDGE_THRESHOLD_MIN,lumaMax*EDGE_THRESHOLD_MAX)){return inputColor;}float lumaDownLeft=luminance(texture2D(inputBuffer,vUvDownLeft).rgb);float lumaUpRight=luminance(texture2D(inputBuffer,vUvUpRight).rgb);float lumaUpLeft=luminance(texture2D(inputBuffer,vUvUpLeft).rgb);float lumaDownRight=luminance(texture2D(inputBuffer,vUvDownRight).rgb);float lumaDownUp=lumaDown+lumaUp;float lumaLeftRight=lumaLeft+lumaRight;float lumaLeftCorners=lumaDownLeft+lumaUpLeft;float lumaDownCorners=lumaDownLeft+lumaDownRight;float lumaRightCorners=lumaDownRight+lumaUpRight;float lumaUpCorners=lumaUpRight+lumaUpLeft;float edgeHorizontal=(abs(-2.0*lumaLeft+lumaLeftCorners)+abs(-2.0*lumaCenter+lumaDownUp)*2.0+abs(-2.0*lumaRight+lumaRightCorners));float edgeVertical=(abs(-2.0*lumaUp+lumaUpCorners)+abs(-2.0*lumaCenter+lumaLeftRight)*2.0+abs(-2.0*lumaDown+lumaDownCorners));bool isHorizontal=(edgeHorizontal>=edgeVertical);float stepLength=isHorizontal?texelSize.y:texelSize.x;float luma1=isHorizontal?lumaDown:lumaLeft;float luma2=isHorizontal?lumaUp:lumaRight;float gradient1=abs(luma1-lumaCenter);float gradient2=abs(luma2-lumaCenter);bool is1Steepest=gradient1>=gradient2;float gradientScaled=0.25*max(gradient1,gradient2);float lumaLocalAverage=0.0;if(is1Steepest){stepLength=-stepLength;lumaLocalAverage=0.5*(luma1+lumaCenter);}else{lumaLocalAverage=0.5*(luma2+lumaCenter);}vec2 currentUv=uv;if(isHorizontal){currentUv.y+=stepLength*0.5;}else{currentUv.x+=stepLength*0.5;}vec2 offset=isHorizontal?vec2(texelSize.x,0.0):vec2(0.0,texelSize.y);vec2 uv1=currentUv-offset*QUALITY(0);vec2 uv2=currentUv+offset*QUALITY(0);float lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);float lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd1-=lumaLocalAverage;lumaEnd2-=lumaLocalAverage;bool reached1=abs(lumaEnd1)>=gradientScaled;bool reached2=abs(lumaEnd2)>=gradientScaled;bool reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(1);}if(!reached2){uv2+=offset*QUALITY(1);}if(!reachedBoth){for(int i=2;i<SAMPLES;++i){if(!reached1){lumaEnd1=luminance(texture2D(inputBuffer,uv1).rgb);lumaEnd1=lumaEnd1-lumaLocalAverage;}if(!reached2){lumaEnd2=luminance(texture2D(inputBuffer,uv2).rgb);lumaEnd2=lumaEnd2-lumaLocalAverage;}reached1=abs(lumaEnd1)>=gradientScaled;reached2=abs(lumaEnd2)>=gradientScaled;reachedBoth=reached1&&reached2;if(!reached1){uv1-=offset*QUALITY(i);}if(!reached2){uv2+=offset*QUALITY(i);}if(reachedBoth){break;}}}float distance1=isHorizontal?(uv.x-uv1.x):(uv.y-uv1.y);float distance2=isHorizontal?(uv2.x-uv.x):(uv2.y-uv.y);bool isDirection1=distance1<distance2;float distanceFinal=min(distance1,distance2);float edgeThickness=(distance1+distance2);bool isLumaCenterSmaller=lumaCenter<lumaLocalAverage;bool correctVariation1=(lumaEnd1<0.0)!=isLumaCenterSmaller;bool correctVariation2=(lumaEnd2<0.0)!=isLumaCenterSmaller;bool correctVariation=isDirection1?correctVariation1:correctVariation2;float pixelOffset=-distanceFinal/edgeThickness+0.5;float finalOffset=correctVariation?pixelOffset:0.0;float lumaAverage=ONE_OVER_TWELVE*(2.0*(lumaDownUp+lumaLeftRight)+lumaLeftCorners+lumaRightCorners);float subPixelOffset1=clamp(abs(lumaAverage-lumaCenter)/lumaRange,0.0,1.0);float subPixelOffset2=(-2.0*subPixelOffset1+3.0)*subPixelOffset1*subPixelOffset1;float subPixelOffsetFinal=subPixelOffset2*subPixelOffset2*SUBPIXEL_QUALITY;finalOffset=max(finalOffset,subPixelOffsetFinal);vec2 finalUv=uv;if(isHorizontal){finalUv.y+=finalOffset*stepLength;}else{finalUv.x+=finalOffset*stepLength;}return texture2D(inputBuffer,finalUv);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=fxaa(inputColor,uv);}`, Ta = "varying vec2 vUvDown;varying vec2 vUvUp;varying vec2 vUvLeft;varying vec2 vUvRight;varying vec2 vUvDownLeft;varying vec2 vUvUpRight;varying vec2 vUvUpLeft;varying vec2 vUvDownRight;void mainSupport(const in vec2 uv){vUvDown=uv+vec2(0.0,-1.0)*texelSize;vUvUp=uv+vec2(0.0,1.0)*texelSize;vUvRight=uv+vec2(1.0,0.0)*texelSize;vUvLeft=uv+vec2(-1.0,0.0)*texelSize;vUvDownLeft=uv+vec2(-1.0,-1.0)*texelSize;vUvUpRight=uv+vec2(1.0,1.0)*texelSize;vUvUpLeft=uv+vec2(-1.0,1.0)*texelSize;vUvDownRight=uv+vec2(1.0,-1.0)*texelSize;}", Ea = class extends I {
...
}, Sa = "uniform float gamma;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=LinearToGamma(max(inputColor,0.0),gamma);}", Ca = class extends I {
  /**
  ...
  constructor({ blendFunction: e = g.SRC, gamma: t = 2 } = {}) {
    super("GammaCorrectionEffect", Sa, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["gamma", new c(t)]
      ])
...
function ya(e, t, i) {
  ...
  let a;
  if (r.has(t) || console.error("Invalid noise texture format"), i === Y) {
    a = new Uint8Array(e * r.get(t));
    for (let n = 0, s = a.length; n < s; ++n)
      a[n] = Math.random() * 255 + 0.5;
  } else {
    a = new Float32Array(e * r.get(t));
    for (let n = 0, s = a.length; n < s; ++n)
      a[n] = Math.random();
  }
  return a;
...
}, Ma = "uniform lowp sampler2D perturbationMap;uniform bool active;uniform float columns;uniform float random;uniform vec2 seeds;uniform vec2 distortion;void mainUv(inout vec2 uv){if(active){if(uv.y<distortion.x+columns&&uv.y>distortion.x-columns*random){float sx=clamp(ceil(seeds.x),0.0,1.0);uv.y=sx*(1.0-(uv.y+distortion.y))+(1.0-sx)*distortion.y;}if(uv.x<distortion.y+columns&&uv.x>distortion.y-columns*random){float sy=clamp(ceil(seeds.y),0.0,1.0);uv.x=sy*distortion.x+(1.0-sy)*(1.0-(uv.x+distortion.x));}vec2 normal=texture2D(perturbationMap,uv*random*random).rg;uv+=normal*seeds*(random*0.2);}}", Ve = "Glitch.Generated";
function Z(e, t) {
  return e + Math.random() * (t - e);
}
var Ba = class extends I {
  /**
  ...
  constructor({
    ...
    delay: t = new p(1.5, 3.5),
    duration: i = new p(0.6, 1),
    strength: r = new p(0.3, 1),
    columns: a = 0.05,
    ratio: n = 0.85,
    perturbationMap: s = null,
    dtSize: o = 64
  } = {}) {
    if (super("GlitchEffect", Ma, {
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["random", new c(1)],
        ["seeds", new c(new p())],
        ["distortion", new c(new p())]
      ])
    }), s === null) {
      const l = new et(o, o, z);
      l.name = Ve, this.perturbationMap = l;
    } else
      this.perturbationMap = s;
    this.time = 0, this.distortion = this.uniforms.get("distortion").value, this.delay = t, this.duration = i, this.breakPoint = new p(
      Z(this.delay.x, this.delay.y),
      Z(this.duration.x, this.duration.y)
    ), this.strength = r, this.mode = Ee.SPORADIC, this.ratio = n, this.chromaticAberrationOffset = e;
  }
  /**
   * Random number seeds.
   *
  ...
  set perturbationMap(e) {
    ...
    t !== null && t.name === Ve && t.dispose(), e.minFilter = e.magFilter = P, e.wrapS = e.wrapT = se, e.generateMipmaps = !1, this.uniforms.get("perturbationMap").value = e;
  }
  /**
   ...
   */
  update(e, t, i) {
    const r = this.mode, a = this.breakPoint, n = this.chromaticAberrationOffset, s = this.strength;
    let o = this.time, l = !1, u = 0, f = 0, h;
    r !== Ee.DISABLED && (r === Ee.SPORADIC && (o += i, h = o > a.x, o >= a.x + a.y && (a.set(
      Z(this.delay.x, this.delay.y),
      Z(this.duration.x, this.duration.y)
    ), o = 0)), u = Math.random(), this.uniforms.get("random").value = u, h && u > this.ratio || r === Ee.CONSTANT_WILD ? (l = !0, u *= s.y * 0.03, f = Z(-Math.PI, Math.PI), this.seeds.set(Z(-s.y, s.y), Z(-s.y, s.y)), this.distortion.set(Z(0, 1), Z(0, 1))) : (h || r === Ee.CONSTANT_MILD) && (l = !0, u *= s.x * 0.03, f = Z(-Math.PI, Math.PI), this.seeds.set(Z(-s.x, s.x), Z(-s.x, s.x)), this.distortion.set(Z(0, 1), Z(0, 1))), this.time = o), n !== null && (l ? n.set(Math.cos(f), Math.sin(f)).multiplyScalar(u) : n.set(0, 0)), this.uniforms.get("active").value = l;
  }
  /**
...
bool keep=!isMaxDepth&&depthTest(depth.x,depth.y);
#endif
if(keep){gl_FragColor=texture2D(inputBuffer,vUv);}else{discard;}}`, Mt = class extends w {
  /**
  ...
  constructor() {
    super({
      ...
      defines: {
        ...
        DEPTH_PACKING_0: "0",
        DEPTH_PACKING_1: "0",
        DEPTH_TEST_STRATEGY: Be.KEEP_MAX_DEPTH
      },
      uniforms: {
        inputBuffer: new c(null),
        depthBuffer0: new c(null),
        depthBuffer1: new c(null),
        cameraNearFar: new c(new p(1, 1))
      },
      blending: G,
      toneMapped: !1,
      depthWrite: !1,
  ...
  set keepFar(e) {
    this.maxDepthStrategy = e ? Be.KEEP_MAX_DEPTH : Be.DISCARD_MAX_DEPTH;
  }
  /**
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNearFar.value.set(e.near, e.far), e instanceof Re ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0);
  }
}, Ia = `#include <common>
#include <dithering_pars_fragment>
#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#include <dithering_fragment>
  ...
  set samples(e) {
    ...
    this.defines.SAMPLES_INT = t.toFixed(0), this.defines.SAMPLES_FLOAT = t.toFixed(1), this.needsUpdate = !0;
  }
  /**
  ...
  constructor(e, t, i = null) {
    super("RenderPass", e, t), this.needsSwap = !1, this.clearPass = new me(), this.overrideMaterialManager = i === null ? null : new gt(i), this.ignoreBackground = !1, this.skipShadowMapUpdate = !1, this.selection = null;
  }
  set mainScene(e) {
    this.scene = e;
  }
  ...
  set overrideMaterial(e) {
    ...
    e !== null ? t !== null ? t.setMaterial(e) : this.overrideMaterialManager = new gt(e) : t !== null && (t.dispose(), this.overrideMaterialManager = null);
  }
  /**
...
uniform lowp sampler2D map;
#endif
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv);}`, ut = /* @__PURE__ */ new L(), Ft = /* @__PURE__ */ new O(), ba = class extends I {
  /**
  ...
  constructor(e, t, {
    ...
    clampMax: l = 1,
    blur: u = !0,
    kernelSize: f = te.SMALL,
    resolutionScale: h = 0.5,
    width: d = x.AUTO_SIZE,
    height: v = x.AUTO_SIZE,
    resolutionX: A = d,
    resolutionY: m = v
  } = {}) {
    ...
    }), this.camera = e, this._lightSource = t, this.lightSource = t, this.lightScene = new dt(), this.screenPosition = new p(), this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "GodRays.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "GodRays.Target.B", this.uniforms.get("map").value = this.renderTargetB.texture, this.renderTargetLight = new T(1, 1), this.renderTargetLight.texture.name = "GodRays.Light", this.renderTargetLight.depthTexture = new Me(), this.renderPassLight = new ze(this.lightScene, e), this.renderPassLight.clearPass.overrideClearColor = new N(0), this.clearPass = new me(!0, !1, !1), this.clearPass.overrideClearColor = new N(0), this.blurPass = new ge({ kernelSize: f }), this.blurPass.enabled = u, this.depthMaskPass = new q(new Mt());
    const S = this.depthMaskMaterial;
    S.depthBuffer1 = this.renderTargetLight.depthTexture, S.copyCameraSettings(e), this.godRaysPass = new q(new vi(this.screenPosition));
    const C = this.godRaysMaterial;
    C.density = a, C.decay = n, C.weight = s, C.exposure = o, C.maxIntensity = l, C.samples = r;
    const E = this.resolution = new x(this, A, m, h);
    E.addEventListener("change", (D) => this.setSize(E.baseWidth, E.baseHeight));
  }
  set mainCamera(e) {
  ...
  set lightSource(e) {
    this._lightSource = e, e !== null && (e.material.depthWrite = !1, e.material.transparent = !0);
  }
  /**
  ...
  update(e, t, i) {
    ...
    r.material.depthWrite = !0, r.matrixAutoUpdate = !1, r.updateWorldMatrix(!0, !1), a !== null && (n || Ft.copy(r.matrix), r.matrix.copy(r.matrixWorld)), this.lightScene.add(r), this.renderPassLight.render(e, o), this.clearPass.render(e, s), this.depthMaskPass.render(e, o, s), r.material.depthWrite = !1, r.matrixAutoUpdate = n, a !== null && (n || r.matrix.copy(Ft), a.add(r)), ut.setFromMatrixPosition(r.matrixWorld).project(this.camera), this.screenPosition.set(
      Math.min(Math.max((ut.x + 1) * 0.5, -1), 2),
      Math.min(Math.max((ut.y + 1) * 0.5, -1), 2)
    ), this.blurPass.enabled && this.blurPass.render(e, s, s), this.godRaysPass.render(e, s, this.renderTargetB);
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    i.setBaseSize(e, t);
    const r = i.width, a = i.height;
    this.renderTargetA.setSize(r, a), this.renderTargetB.setSize(r, a), this.renderTargetLight.setSize(r, a), this.blurPass.resolution.copy(i);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  constructor({ blendFunction: e = g.OVERLAY, scale: t = 1, lineWidth: i = 0 } = {}) {
    ...
    }), this.resolution = new p(), this.s = 0, this.scale = t, this.l = 0, this.lineWidth = i;
  }
  /**
   * The scale.
   *
   ...
   */
  constructor({
    distortion: e = new p(0, 0),
    principalPoint: t = new p(0, 0),
...
void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=vec4(texture2D(lut,vec2(inputColor.r,0.5)).r,texture2D(lut,vec2(inputColor.g,0.5)).r,texture2D(lut,vec2(inputColor.b,0.5)).r,inputColor.a);}`, Ga = class extends I {
  ...
  set lut(e) {
    this.uniforms.get("lut").value = e, e !== null && (e.type === J || e.type === $) && this.defines.set("LUT_PRECISION_HIGH", "1");
  }
}, pi = {
...
function Lt(e, t, i) {
  ...
  if (r.width = e, r.height = t, i instanceof Image)
    ...
    const n = a.createImageData(e, t);
    n.data.set(i), a.putImageData(n, 0, 0);
  }
  return r;
}
var ue = class gi {
   ...
   */
  toCanvas() {
    return typeof document > "u" ? null : Lt(this.width, this.height, this.data);
  }
  /**
  ...
  static from(t) {
    ...
    if (t instanceof Image) {
      const n = Lt(i, r, t);
      n !== null && (a = n.getContext("2d").getImageData(0, 0, i, r).data);
    } else
      a = t.data;
    return new gi(i, r, a);
  }
...
`, Ot = /* @__PURE__ */ new N(), Ne = class Ze extends Xe {
  /**
   ...
   */
  constructor(t, i) {
    super(t, i, i, i), this.type = J, this.format = z, this.minFilter = R, this.magFilter = R, this.wrapS = st, this.wrapT = st, this.wrapR = st, this.unpackAlignment = 1, this.needsUpdate = !0, this.colorSpace = je, this.domainMin = new L(0, 0, 0), this.domainMax = new L(1, 1, 1);
  }
  /**
  ...
  scaleUp(t, i = !0) {
    ...
    return t <= r.width ? a = Promise.reject(new Error("The target size must be greater than the current size")) : a = new Promise((n, s) => {
      ...
      l.addEventListener("error", (f) => s(f.error)), l.addEventListener("message", (f) => {
        const h = new Ze(f.data, t);
        this.colorSpace = h.colorSpace, h.type = this.type, h.name = this.name, URL.revokeObjectURL(o), n(h);
      });
      const u = i ? [r.data.buffer] : [];
      l.postMessage({
        operation: pi.SCALE_UP,
        data: r.data,
        size: t
      }, u);
    }), a;
   ...
   */
  applyLUT(t) {
    const i = this.image, r = t.image, a = Math.min(i.width, i.height, i.depth), n = Math.min(r.width, r.height, r.depth);
    if (a !== n)
      console.error("Size mismatch");
    else if (t.type !== J || this.type !== J)
      console.error("Both LUTs must be FloatType textures");
    else if (t.format !== z || this.format !== z)
      console.error("Both LUTs must be RGBA textures");
    else {
      const s = i.data, o = r.data, l = a, u = l ** 2, f = l - 1;
      for (let h = 0, d = l ** 3; h < d; ++h) {
        const v = h * 4, A = s[v + 0] * f, m = s[v + 1] * f, S = s[v + 2] * f, C = Math.round(A + m * l + S * u) * 4;
        s[v + 0] = o[C + 0], s[v + 1] = o[C + 1], s[v + 2] = o[C + 2];
      }
      this.needsUpdate = !0;
    }
    return this;
  ...
  convertToUint8() {
    if (this.type === J) {
      ...
      for (let r = 0, a = t.length; r < a; ++r)
        i[r] = t[r] * 255 + 0.5;
      this.image.data = i, this.type = Y, this.needsUpdate = !0;
    }
    return this;
  }
  /**
  ...
  convertToFloat() {
    if (this.type === Y) {
      ...
      for (let r = 0, a = t.length; r < a; ++r)
        i[r] = t[r] / 255;
      this.image.data = i, this.type = J, this.needsUpdate = !0;
    }
    return this;
  }
  /**
  ...
  convertLinearToSRGB() {
    ...
    if (this.type === J) {
      for (let i = 0, r = t.length; i < r; i += 4)
        Ot.fromArray(t, i).convertLinearToSRGB().toArray(t, i);
      this.colorSpace = y, this.needsUpdate = !0;
    } else
  ...
  convertSRGBToLinear() {
    ...
    if (this.type === J) {
      for (let i = 0, r = t.length; i < r; i += 4)
        Ot.fromArray(t, i).convertSRGBToLinear().toArray(t, i);
      this.colorSpace = je, this.needsUpdate = !0;
    } else
      console.error("Color space conversion requires FloatType data");
    return this;
  }
  ...
  toDataTexture() {
    ...
    return r.name = this.name, r.type = this.type, r.format = this.format, r.minFilter = R, r.magFilter = R, r.wrapS = this.wrapS, r.wrapT = this.wrapT, r.generateMipmaps = !1, r.needsUpdate = !0, this.colorSpace = r.colorSpace, r;
  }
  /**
   ...
   */
  static from(t) {
    const i = t.image, { width: r, height: a } = i, n = Math.min(r, a);
    let s;
    if (i instanceof Image) {
      const u = ue.from(i).data;
      if (r > a) {
        s = new Uint8Array(u.length);
        for (let f = 0; f < n; ++f)
          for (let h = 0; h < n; ++h)
            for (let d = 0; d < n; ++d) {
              const v = (d + f * n + h * n * n) * 4, A = (d + h * n + f * n * n) * 4;
              s[A + 0] = u[v + 0], s[A + 1] = u[v + 1], s[A + 2] = u[v + 2], s[A + 3] = u[v + 3];
            }
      } else
        s = new Uint8Array(u.buffer);
    } else
      s = i.data.slice();
    const o = new Ze(s, n);
  ...
  static createNeutral(t) {
    const i = new Float32Array(t ** 3 * 4), r = t ** 2, a = 1 / (t - 1);
    for (let s = 0; s < t; ++s)
      for (let o = 0; o < t; ++o)
        for (let l = 0; l < t; ++l) {
          const u = (s + o * t + l * r) * 4;
          i[u + 0] = s * a, i[u + 1] = o * a, i[u + 2] = l * a, i[u + 3] = 1;
        }
    const n = new Ze(i, t);
...
#endif
outputColor=vec4(c,inputColor.a);}`, Nt = class extends I {
  /**
   * Constructs a new color grading effect.
   *
   * @param {Texture} lut - The lookup texture.
  ...
  set lut(e) {
    ...
    if (this.lut !== e && (i.get("lut").value = e, e !== null)) {
      const r = e.image, a = this.tetrahedralInterpolation;
      if (t.clear(), t.set("LUT_SIZE", Math.min(r.width, r.height).toFixed(16)), t.set("LUT_TEXEL_WIDTH", (1 / r.width).toFixed(16)), t.set("LUT_TEXEL_HEIGHT", (1 / r.height).toFixed(16)), i.get("domainMin").value = null, i.get("domainMax").value = null, (e.type === J || e.type === $) && t.set("LUT_PRECISION_HIGH", "1"), r.width > r.height ? t.set("LUT_STRIP_HORIZONTAL", "1") : e instanceof Xe && t.set("LUT_3D", "1"), e instanceof Ne) {
        const n = e.domainMin, s = e.domainMax;
        (n.x !== 0 || n.y !== 0 || n.z !== 0 || s.x !== 1 || s.y !== 1 || s.z !== 1) && (t.set("CUSTOM_INPUT_DOMAIN", "1"), i.get("domainMin").value = n.clone(), i.get("domainMax").value = s.clone());
      }
      this.tetrahedralInterpolation = a;
    }
  }
  /**
  ...
  updateScaleOffset() {
    ...
    if (e !== null) {
      ...
      if (this.tetrahedralInterpolation && e instanceof Xe)
        if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
          const a = e.domainMax.clone().sub(e.domainMin);
          i.setScalar(t - 1).divide(a), r.copy(e.domainMin).negate().multiply(i);
        } else
          i.setScalar(t - 1), r.setScalar(0);
      else if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
        const a = e.domainMax.clone().sub(e.domainMin).multiplyScalar(t);
        i.setScalar(t - 1).divide(a), r.copy(e.domainMin).negate().multiply(i).addScalar(1 / (2 * t));
      } else
  ...
  configureTetrahedralInterpolation() {
    const e = this.lut;
    e !== null && (e.minFilter = R, e.magFilter = R, this.tetrahedralInterpolation && (e instanceof Xe ? (e.minFilter = P, e.magFilter = P) : console.warn("Tetrahedral interpolation requires a 3D texture")), e.needsUpdate = !0);
  }
  /**
...
#include <clipping_planes_vertex>
  ...
  constructor(e, t, {
    ...
    super("DepthPass"), this.needsSwap = !1, this.renderPass = new ze(e, t, new ki({
      depthPacking: ae
    }));
    const l = this.renderPass;
    l.skipShadowMapUpdate = !0, l.ignoreBackground = !0;
    const u = l.clearPass;
    u.overrideClearColor = new N(16777215), u.overrideClearAlpha = 1, this.renderTarget = i, this.renderTarget === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: P,
      magFilter: P
    }), this.renderTarget.texture.name = "DepthPass.Target");
    const f = this.resolution = new x(this, s, o, r);
...
outputColor=vec4(color,max(alpha,inputColor.a));
  ...
  constructor(e, t, {
    ...
    kernelSize: u = te.VERY_SMALL,
    blur: f = !1,
    xRay: h = !0,
    multisampling: d = 0,
    resolutionScale: v = 0.5,
    width: A = x.AUTO_SIZE,
    height: m = x.AUTO_SIZE,
    resolutionX: S = A,
    resolutionY: C = m
  } = {}) {
    super("OutlineEffect", Ja, {
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["visibleEdgeColor", new c(new N(o))],
        ["hiddenEdgeColor", new c(new N(l))],
        ["pulse", new c(1)],
        ["patternScale", new c(a)],
    ...
    }), this.blendMode.blendFunction = i, this.patternTexture = r, this.xRay = h, this.scene = e, this.camera = t, this.renderTargetMask = new T(1, 1), this.renderTargetMask.samples = d, this.renderTargetMask.texture.name = "Outline.Mask", this.uniforms.get("maskTexture").value = this.renderTargetMask.texture, this.renderTargetOutline = new T(1, 1, { depthBuffer: !1 }), this.renderTargetOutline.texture.name = "Outline.Edges", this.uniforms.get("edgeTexture").value = this.renderTargetOutline.texture, this.clearPass = new me(), this.clearPass.overrideClearColor = new N(0), this.clearPass.overrideClearAlpha = 1, this.depthPass = new Pt(e, t), this.maskPass = new ze(e, t, new Ai(this.depthPass.texture, t));
    const E = this.maskPass.clearPass;
    E.overrideClearColor = new N(16777215), E.overrideClearAlpha = 1, this.blurPass = new ge({ resolutionScale: v, resolutionX: S, resolutionY: C, kernelSize: u }), this.blurPass.enabled = f;
    const D = this.blurPass.resolution;
    D.addEventListener("change", (ee) => this.setSize(D.baseWidth, D.baseHeight)), this.outlinePass = new q(new mt());
    const K = this.outlinePass.fullscreenMaterial;
    K.inputBuffer = this.renderTargetMask.texture, this.time = 0, this.forceUpdate = !0, this.selection = new St(), this.pulseSpeed = s;
  }
  set mainScene(e) {
   ...
   */
  update(e, t, i) {
    const r = this.scene, a = this.camera, n = this.selection, o = this.uniforms.get("pulse"), l = r.background, u = a.layers.mask;
    (this.forceUpdate || n.size > 0) && (r.background = null, o.value = 1, this.pulseSpeed > 0 && (o.value = Math.cos(this.time * this.pulseSpeed * 10) * 0.375 + 0.625), this.time += i, n.setVisible(!1), this.depthPass.render(e), n.setVisible(!0), a.layers.set(n.layer), this.maskPass.render(e, this.renderTargetMask), a.layers.mask = u, r.background = l, this.outlinePass.render(e, null, this.renderTargetOutline), this.blurPass.enabled && this.blurPass.render(e, this.renderTargetOutline, this.renderTargetOutline)), this.forceUpdate = n.size > 0;
  }
  /**
   * Updates the size of internal render targets.
   *
  ...
  setSize(e, t) {
    ...
    i.setBaseSize(e, t);
    const r = i.width, a = i.height;
    this.depthPass.setSize(r, a), this.renderTargetOutline.setSize(r, a), this.outlinePass.fullscreenMaterial.setSize(r, a);
  }
  /**
   * Performs initialization tasks.
   *
  ...
  constructor(e = 30) {
    ...
    }), this.resolution = new p(), this._granularity = 0, this.granularity = e;
  }
  /**
...
outputColor=vec4(color,inputColor.a);}`, is = class extends I {
  ...
  constructor({
    ...
    super("RealisticBokehEffect", ts, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ...
        ["focalLength", new c(i)],
        ["fStop", new c(r)],
        ["luminanceThreshold", new c(a)],
        ["luminanceGain", new c(n)],
        ["bias", new c(s)],
        ["fringe", new c(o)],
        ["maxBlur", new c(l)],
        ["dof", new c(null)]
  ...
  set manualDoF(e) {
    this.manualDoF !== e && (e ? (this.defines.set("MANUAL_DOF", "1"), this.uniforms.get("dof").value = new Pe(0.2, 1, 0.2, 2)) : (this.defines.delete("MANUAL_DOF"), this.uniforms.get("dof").value = null), this.setChanged());
  }
  /**
...
vec2 sl=vec2(sin(y*count),cos(y*count));outputColor=vec4(sl.xyx,inputColor.a);}`, as = class extends I {
  ...
  constructor({ blendFunction: e = g.OVERLAY, density: t = 1.25, scrollSpeed: i = 0 } = {}) {
    ...
    }), this.resolution = new p(), this.d = t, this.scrollSpeed = i;
  }
  /**
  ...
  constructor(e, t = new L(), {
    ...
    }), this.position = t, this.speed = i, this.camera = e, this.screenPosition = this.uniforms.get("center").value, this.time = 0, this.active = !1;
  }
  set mainCamera(e) {
    this.camera = e;
  }
  ...
  update(e, t, i) {
    ...
    if (this.active) {
      ...
      a.getWorldDirection(Ue), Ht.copy(a.position).sub(r), s.value = Ue.angleTo(Ht) > os, s.value && (n.get("cameraDistance").value = a.position.distanceTo(r), Ue.copy(r).project(a), this.screenPosition.set((Ue.x + 1) * 0.5, (Ue.y + 1) * 0.5)), this.time += i * this.speed;
      const l = this.time - o;
   ...
   */
  constructor(e, t, i) {
    super(i), this.setAttributes(this.getAttributes() | V.DEPTH), this.camera = t, this.depthPass = new Pt(e, t), this.clearPass = new me(!0, !1, !1), this.clearPass.overrideClearColor = new N(0), this.depthMaskPass = new q(new Mt());
    const r = this.depthMaskMaterial;
    r.copyCameraSettings(t), r.depthBuffer1 = this.depthPass.texture, r.depthPacking1 = ae, r.depthMode = vt, this.renderTargetMasked = new T(1, 1, { depthBuffer: !1 }), this.renderTargetMasked.texture.name = "Bloom.Masked", this.selection = new St(), this._inverted = !1, this._ignoreBackground = !1;
  }
  set mainScene(e) {
  ...
  set inverted(e) {
    this._inverted = e, this.depthMaskMaterial.depthMode = e ? qt : vt;
  }
  /**
   * Indicates whether the mask is inverted.
   *
  ...
  set ignoreBackground(e) {
    this._ignoreBackground = e, this.depthMaskMaterial.maxDepthStrategy = e ? Be.DISCARD_MAX_DEPTH : Be.KEEP_MAX_DEPTH;
  }
  /**
   ...
   */
  update(e, t, i) {
    const r = this.camera, a = this.selection, n = this.inverted;
    let s = t;
    if (this.ignoreBackground || !n || a.size > 0) {
      const o = r.layers.mask;
      r.layers.set(a.layer), this.depthPass.render(e), r.layers.mask = o, s = this.renderTargetMasked, this.clearPass.render(e, s), this.depthMaskPass.render(e, t, s);
    }
    super.update(e, s, i);
  }
  /**
   ...
   */
  initialize(e, t, i) {
    super.initialize(e, t, i), this.clearPass.initialize(e, t, i), this.depthPass.initialize(e, t, i), this.depthMaskPass.initialize(e, t, i), e !== null && e.capabilities.logarithmicDepthBuffer && (this.depthMaskPass.fullscreenMaterial.defines.LOG_DEPTH = "1"), i !== void 0 && (this.renderTargetMasked.texture.type = i, e !== null && e.outputColorSpace === y && (this.renderTargetMasked.texture.colorSpace = y));
  }
}, cs = "uniform vec3 weightsR;uniform vec3 weightsG;uniform vec3 weightsB;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec3 color=vec3(dot(inputColor.rgb,weightsR),dot(inputColor.rgb,weightsG),dot(inputColor.rgb,weightsB));outputColor=vec4(color,inputColor.a);}", fs = class extends I {
  /**
  ...
  constructor({ blendFunction: e, intensity: t = 1 } = {}) {
    super("SepiaEffect", cs, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["weightsR", new c(new L(0.393, 0.769, 0.189))],
        ["weightsG", new c(new L(0.349, 0.686, 0.168))],
        ["weightsB", new c(new L(0.272, 0.534, 0.131))]
      ])
    });
  }
  /**
...
}, hs = `varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, At = class extends w {
  /**
   ...
   */
  constructor(e = new p(), t = Bt.COLOR) {
    super({
...
}, vs = `#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
vec2 d;vec3 coords;coords.x=searchXLeft(vOffset[0].xy,vOffset[2].x);coords.y=vOffset[1].y;d.x=coords.x;float e1=texture2D(inputBuffer,coords.xy).r;coords.z=searchXRight(vOffset[0].zw,vOffset[2].y);d.y=coords.z;d=round(resolution.xx*d+-vPixCoord.xx);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.zy,vec2(1,0)).r;weights.rg=area(sqrtD,e1,e2,subsampleIndices.y);coords.y=vUv.y;detectHorizontalCornerPattern(weights.rg,coords.xyzy,d);
...
#endif
}if(e.r>0.0){vec2 d;vec3 coords;coords.y=searchYUp(vOffset[1].xy,vOffset[2].z);coords.x=vOffset[0].x;d.x=coords.y;float e1=texture2D(inputBuffer,coords.xy).g;coords.z=searchYDown(vOffset[1].zw,vOffset[2].w);d.y=coords.z;d=round(resolution.yy*d-vPixCoord.yy);vec2 sqrtD=sqrt(abs(d));float e2=sampleLevelZeroOffset(inputBuffer,coords.xz,vec2(0,1)).g;weights.ba=area(sqrtD,e1,e2,subsampleIndices.x);coords.x=vUv.x;detectVerticalCornerPattern(weights.ba,coords.xyxz,d);}gl_FragColor=weights;}`, ps = "uniform vec2 texelSize;uniform vec2 resolution;varying vec2 vUv;varying vec4 vOffset[3];varying vec2 vPixCoord;void main(){vUv=position.xy*0.5+0.5;vPixCoord=vUv*resolution;vOffset[0]=vUv.xyxy+texelSize.xyxy*vec4(-0.25,-0.125,1.25,-0.125);vOffset[1]=vUv.xyxy+texelSize.xyxy*vec4(-0.125,-0.25,-0.125,1.25);vOffset[2]=vec4(vOffset[0].xz,vOffset[1].yw)+vec4(-2.0,2.0,-2.0,2.0)*texelSize.xxyy*MAX_SEARCH_STEPS_FLOAT;gl_Position=vec4(position.xy,1.0,1.0);}", xi = class extends w {
  /**
  ...
  constructor({
    ...
    preset: t = Se.MEDIUM,
    edgeDetectionMode: i = Bt.COLOR,
    predicationMode: r = mi.DISABLED
  } = {}) {
    super("SMAAEffect", gs, {
      vertexShader: ms,
      blendFunction: e,
    ...
    let a, n;
    arguments.length > 1 && (a = arguments[0], n = arguments[1], arguments.length > 2 && (t = arguments[2]), arguments.length > 3 && (i = arguments[3])), this.renderTargetEdges = new T(1, 1, { depthBuffer: !1 }), this.renderTargetEdges.texture.name = "SMAA.Edges", this.renderTargetWeights = this.renderTargetEdges.clone(), this.renderTargetWeights.texture.name = "SMAA.Weights", this.uniforms.get("weightMap").value = this.renderTargetWeights.texture, this.clearPass = new me(!0, !1, !1), this.clearPass.overrideClearColor = new N(0), this.clearPass.overrideClearAlpha = 1, this.edgeDetectionPass = new q(new At()), this.edgeDetectionMaterial.edgeDetectionMode = i, this.edgeDetectionMaterial.predicationMode = r, this.weightsPass = new q(new xi());
    const s = new pe();
    s.onLoad = () => {
      const o = new Je(a);
      o.name = "SMAA.Search", o.magFilter = P, o.minFilter = P, o.generateMipmaps = !1, o.needsUpdate = !0, o.flipY = !0, this.weightsMaterial.searchTexture = o;
      const l = new Je(n);
      l.name = "SMAA.Area", l.magFilter = R, l.minFilter = R, l.generateMipmaps = !1, l.needsUpdate = !0, l.flipY = !1, this.weightsMaterial.areaTexture = l, this.dispatchEvent({ type: "load" });
    }, s.itemStart("search"), s.itemStart("area"), a !== void 0 && n !== void 0 ? (s.itemEnd("search"), s.itemEnd("area")) : typeof Image < "u" && (a = new Image(), n = new Image(), a.addEventListener("load", () => s.itemEnd("search")), n.addEventListener("load", () => s.itemEnd("area")), a.src = xt, n.src = Dt), this.applyPreset(t);
  }
  /**
   * The edges texture.
   *
...
ao=clamp(1.0-pow(1.0-ao,abs(intensity)),0.0,1.0);
#endif
}gl_FragColor.r=ao;}`, Ds = "uniform vec2 noiseScale;varying vec2 vUv;varying vec2 vUv2;void main(){vUv=position.xy*0.5+0.5;vUv2=vUv*noiseScale;gl_Position=vec4(position.xy,1.0,1.0);}", Di = class extends w {
  /**
  ...
  constructor(e) {
    super({
      ...
      uniforms: {
        ...
        inverseProjectionMatrix: new c(new O()),
        projectionMatrix: new c(new O()),
        texelSize: new c(new p()),
        cameraNearFar: new c(new p()),
        distanceCutoff: new c(new p()),
        proximityCutoff: new c(new p()),
        noiseScale: new c(new p()),
  ...
  get worldDistanceThreshold() {
    return -de(this.distanceThreshold, this.near, this.far);
  }
  set worldDistanceThreshold(e) {
    this.distanceThreshold = le(-e, this.near, this.far);
  }
  /**
  ...
  get worldDistanceFalloff() {
    return -de(this.distanceFalloff, this.near, this.far);
  }
  set worldDistanceFalloff(e) {
    this.distanceFalloff = le(-e, this.near, this.far);
  }
  /**
  ...
  get worldProximityThreshold() {
    return -de(this.proximityThreshold, this.near, this.far);
  }
  set worldProximityThreshold(e) {
    this.proximityThreshold = le(-e, this.near, this.far);
  }
  /**
  ...
  get worldProximityFalloff() {
    return -de(this.proximityFalloff, this.near, this.far);
  }
  set worldProximityFalloff(e) {
    this.proximityFalloff = le(-e, this.near, this.far);
  }
  /**
   ...
   */
  copyCameraSettings(e) {
    e && (this.uniforms.cameraNearFar.value.set(e.near, e.far), this.uniforms.projectionMatrix.value.copy(e.projectionMatrix), this.uniforms.inverseProjectionMatrix.value.copy(e.projectionMatrix).invert(), e instanceof Re ? this.defines.PERSPECTIVE_CAMERA = "1" : delete this.defines.PERSPECTIVE_CAMERA, this.needsUpdate = !0);
  }
  /**
   * Sets the size of this object.
   *
...
gl_FragColor=vec4(n[index],d[index]);}`, Ts = "uniform vec2 texelSize;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vUv0=uv;vUv1=vec2(uv.x,uv.y+texelSize.y);vUv2=vec2(uv.x+texelSize.x,uv.y);vUv3=uv+texelSize;gl_Position=vec4(position.xy,1.0,1.0);}", wi = class extends w {
  ...
  constructor({
    ...
    const s = new wi();
    s.normalBuffer = e, this.fullscreenMaterial = s, this.needsDepthTexture = !0, this.needsSwap = !1, this.renderTarget = new T(1, 1, {
      minFilter: P,
      magFilter: P,
      depthBuffer: !1,
      type: J
    }), this.renderTarget.texture.name = "DepthDownsamplingPass.Target", this.renderTarget.texture.generateMipmaps = !1;
    const o = this.resolution = new x(this, a, n, t);
...
outputColor=vec4(vec3(1.0-ao),inputColor.a);
  ...
  constructor(e, t, {
    ...
    fade: K = 0.01,
    color: ee = null,
    resolutionScale: ie = 1,
    width: re = x.AUTO_SIZE,
    height: F = x.AUTO_SIZE,
    resolutionX: Ae = re,
    resolutionY: xe = F
  } = {}) {
    super("SSAOEffect", Es, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["aoBuffer", new c(null)],
        ["normalDepthBuffer", new c(n)],
        ["luminanceInfluence", new c(S)],
        ["color", new c(null)],
        ["intensity", new c(E)],
        ["scale", new c(0)]
        // Unused.
      ])
    }), this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "AO.Target", this.uniforms.get("aoBuffer").value = this.renderTarget.texture;
    const ne = this.resolution = new x(this, Ae, xe, ie);
    ne.addEventListener("change", (Ge) => this.setSize(ne.baseWidth, ne.baseHeight)), this.camera = e, this.depthDownsamplingPass = new Ti({ normalBuffer: t, resolutionScale: ie }), this.depthDownsamplingPass.enabled = n === null, this.ssaoPass = new q(new Di(e));
    const fe = new et(zt, zt, z);
    fe.wrapS = fe.wrapT = se;
    const k = this.ssaoMaterial;
    k.normalBuffer = t, k.noiseTexture = fe, k.minRadiusScale = m, k.samples = r, k.radius = C, k.rings = a, k.fade = K, k.bias = D, k.distanceThreshold = h, k.distanceFalloff = d, k.proximityThreshold = v, k.proximityFalloff = A, o !== void 0 && (k.worldDistanceThreshold = o), l !== void 0 && (k.worldDistanceFalloff = l), u !== void 0 && (k.worldProximityThreshold = u), f !== void 0 && (k.worldProximityFalloff = f), n !== null && (this.ssaoMaterial.normalDepthBuffer = n, this.defines.set("NORMAL_DEPTH", "1")), this.depthAwareUpsampling = s, this.color = ee;
  }
  set mainCamera(e) {
  ...
  set color(e) {
    ...
    e !== null ? i.has("COLORIZE") ? t.get("color").value.set(e) : (i.set("COLORIZE", "1"), t.get("color").value = new N(e), this.setChanged()) : i.has("COLORIZE") && (i.delete("COLORIZE"), t.get("color").value = null, this.setChanged());
  }
  /**
  ...
  setSize(e, t) {
    ...
    i.setBaseSize(e, t);
    const r = i.width, a = i.height;
    this.ssaoMaterial.copyCameraSettings(this.camera), this.ssaoMaterial.setSize(r, a), this.renderTarget.setSize(r, a), this.depthDownsamplingPass.resolution.scale = i.scale, this.depthDownsamplingPass.setSize(e, t);
  }
  /**
   * Performs initialization tasks.
   *
...
}, Cs = `#ifdef TEXTURE_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
...
vUv2=(uvTransform*vec3(uv,1.0)).xy;
  ...
  setTextureSwizzleRGBA(e, t = e, i = e, r = e) {
    const a = "rgba";
    let n = "";
    (e !== he.RED || t !== he.GREEN || i !== he.BLUE || r !== he.ALPHA) && (n = [".", a[e], a[t], a[i], a[r]].join("")), this.defines.set("TEXEL", "texel" + n), this.setChanged();
  }
  /**
   * Updates this effect.
   *
...
#include <colorspace_fragment>
}`, Ps = "uniform vec4 texelSize;uniform float kernel;uniform float scale;uniform float aspect;uniform vec2 rotation;varying vec2 vUv;varying vec2 vUv2;varying vec2 vOffset;void main(){vec2 uv=position.xy*0.5+0.5;vUv=uv;vUv2=(uv-0.5)*2.0*vec2(aspect,1.0);vUv2=vec2(dot(rotation,vUv2),dot(rotation,vec2(vUv2.y,-vUv2.x)));vOffset=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;gl_Position=vec4(position.xy,1.0,1.0);}", Ei = class extends $e {
  /**
  ...
  constructor({
    ...
    super(), this.fragmentShader = Bs, this.vertexShader = Ps, this.kernelSize = e, this.uniforms.aspect = new c(1), this.uniforms.rotation = new c(new p()), this.uniforms.maskParams = new c(new Pe()), this._offset = t, this._focusArea = r, this._feather = a, this.rotation = i, this.updateParams();
  }
  /**
  ...
  constructor({
    ...
    focusArea: i = 0.4,
    feather: r = 0.3,
    kernelSize: a = te.MEDIUM,
    resolutionScale: n = 0.5,
    resolutionX: s = x.AUTO_SIZE,
    resolutionY: o = x.AUTO_SIZE
  } = {}) {
    super({ kernelSize: a, resolutionScale: n, resolutionX: s, resolutionY: o }), this.blurMaterial = new Ei({ kernelSize: a, offset: e, rotation: t, focusArea: i, feather: r });
  }
...
uniform vec2 maskParams;varying vec2 vUv2;float linearGradientMask(const in float x){return step(maskParams.x,x)-step(maskParams.y,x);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){float mask=linearGradientMask(vUv2.y);vec4 texel=texture2D(map,uv);outputColor=mix(texel,inputColor,mask);}`, Rs = "uniform vec2 rotation;varying vec2 vUv2;void mainSupport(const in vec2 uv){vUv2=(uv-0.5)*2.0*vec2(aspect,1.0);vUv2=vec2(dot(rotation,vUv2),dot(rotation,vec2(vUv2.y,-vUv2.x)));}", bs = class extends I {
  ...
  constructor({
    ...
    focusArea: r = 0.4,
    feather: a = 0.3,
    kernelSize: n = te.MEDIUM,
    resolutionScale: s = 0.5,
    resolutionX: o = x.AUTO_SIZE,
    resolutionY: l = x.AUTO_SIZE
  } = {}) {
    super("TiltShiftEffect", Is, {
      vertexShader: Rs,
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["rotation", new c(new p())],
        ["maskParams", new c(new p())],
        ["map", new c(null)]
      ])
    }), this._offset = t, this._focusArea = r, this._feather = a, this.renderTarget = new T(1, 1, { depthBuffer: !1 }), this.renderTarget.texture.name = "TiltShift.Target", this.uniforms.get("map").value = this.renderTarget.texture, this.blurPass = new Si({
      kernelSize: n,
      resolutionScale: s,
      resolutionX: o,
      resolutionY: l,
    ...
    const u = this.resolution = new x(this, o, l, s);
   ...
   */
  initialize(e, t, i) {
    this.blurPass.initialize(e, t, i), i !== void 0 && (this.renderTarget.texture.type = i, e !== null && e.outputColorSpace === y && (this.renderTarget.texture.colorSpace = y));
  }
}, Us = `#include <packing>
...
#endif
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`, Ci = class extends w {
  /**
  ...
  constructor(e, { minLuminance: t = 0.01, adaptationRate: i = 1 } = {}) {
    super("AdaptiveLuminancePass"), this.fullscreenMaterial = new Ci(), this.needsSwap = !1, this.renderTargetPrevious = new T(1, 1, {
      minFilter: P,
      magFilter: P,
      depthBuffer: !1
    }), this.renderTargetPrevious.texture.name = "Luminance.Previous";
    const r = this.fullscreenMaterial;
    r.luminanceBuffer0 = this.renderTargetPrevious.texture, r.luminanceBuffer1 = e, r.minLuminance = t, r.adaptationRate = i, this.renderTargetAdapted = this.renderTargetPrevious.clone(), this.renderTargetAdapted.texture.name = "Luminance.Adapted", this.copyPass = new _e(this.renderTargetPrevious, !1);
  }
  /**
...
}, Fs = `#include <tonemapping_pars_fragment>
...
outputColor=vec4(toneMapping(inputColor.rgb),inputColor.a);
  ...
  constructor({
    ...
    super("ToneMappingEffect", Fs, {
      blendFunction: e,
      uniforms: /* @__PURE__ */ new Map([
        ["luminanceBuffer", new c(null)],
        ["maxLuminance", new c(a)],
        // Unused
        ["whitePoint", new c(n)],
        ["middleGrey", new c(s)],
        ["averageLuminance", new c(l)]
      ])
    }), this.renderTargetLuminance = new T(1, 1, {
      minFilter: Yi,
      depthBuffer: !1
    ...
    }), this.adaptiveLuminancePass = new yi(this.luminancePass.texture, {
      minLuminance: o,
      adaptationRate: u
  ...
  set mode(e) {
    ...
    this.adaptiveLuminancePass.enabled = e === j.REINHARD2_ADAPTIVE, this.setChanged();
  }
  /**
   ...
   */
  get adaptive() {
    return this.mode === j.REINHARD2_ADAPTIVE;
  }
  set adaptive(e) {
    this.mode = e ? j.REINHARD2_ADAPTIVE : j.REINHARD2;
  }
  /**
   * The luminance adaptation rate.
   *
...
}, Os = `uniform float offset;uniform float darkness;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){const vec2 center=vec2(0.5);vec3 color=inputColor.rgb;
#if VIGNETTE_TECHNIQUE == 0
float d=distance(uv,center);color*=smoothstep(0.8,offset*0.799,d*(darkness+offset));
#else
vec2 coord=(uv-center)*vec2(offset);color=mix(color,vec3(1.0-darkness),dot(coord,coord));
#endif
outputColor=vec4(color,inputColor.a);}`, Ns = class extends I {
  /**
  ...
  constructor({
    blendFunction: e,
    eskil: t = !1,
    technique: i = t ? Ce.ESKIL : Ce.DEFAULT,
    offset: r = 0.5,
    darkness: a = 0.5
  } = {}) {
    super("VignetteEffect", Os, {
      blendFunction: e,
      defines: /* @__PURE__ */ new Map([
   ...
   */
  get eskil() {
    return this.technique === Ce.ESKIL;
  }
  /**
   * Indicates whether Eskil's Vignette technique is enabled.
   *
   ...
   */
  set eskil(e) {
    this.technique = e ? Ce.ESKIL : Ce.DEFAULT;
  }
  /**
  ...
  load(e, t = () => {
    ...
    const a = this.manager, n = new pe(), s = new jt(n);
    s.setPath(this.path), s.setResponseType("text"), a.itemStart(e), s.load(e, (o) => {
      try {
  ...
  loadAsync(e, t = () => {
    ...
    const i = this.manager, r = new pe();
    return new Promise((a, n) => {
      r.onError = (s) => {
        i.itemError(s), n(`Failed to load ${s}`);
      }, this.load(e, a, t);
    });
  }
  /**
  ...
  parse(e) {
    ...
    const a = r[0].trim().split(/\s+/g).map((v) => Number(v)), n = a[1] - a[0], s = a.length, o = s ** 2;
    for (let v = 1, A = a.length; v < A; ++v)
      if (n !== a[v] - a[v - 1])
    ...
    for (; (r = i.exec(e)) !== null; ) {
      ...
      u = Math.max(u, v, A, m);
      const S = f % s, C = Math.floor(f / s) % s, E = Math.floor(f / o) % s, D = (S * o + C * s + E) * 4;
      l[D + 0] = v, l[D + 1] = A, l[D + 2] = m, l[D + 3] = 1, ++f;
    }
  ...
  load(e, t = () => {
    ...
    const a = this.manager, n = new pe(), s = new jt(n);
    s.setPath(this.path), s.setResponseType("text"), s.load(e, (o) => {
      try {
        const l = this.parse(o);
        a.itemEnd(e), t(l);
      } catch (l) {
   ...
   */
  parse(e) {
    const t = /TITLE +"([^"]*)"/, i = /LUT_3D_SIZE +(\d+)/, r = /DOMAIN_MIN +([\d.]+) +([\d.]+) +([\d.]+)/, a = /DOMAIN_MAX +([\d.]+) +([\d.]+) +([\d.]+)/, n = /^([\d.e+-]+) +([\d.e+-]+) +([\d.e+-]+) *$/gm;
    let s = t.exec(e);
    const o = s !== null ? s[1] : null;
    if (s = i.exec(e), s === null)
      throw new Error("Missing LUT_3D_SIZE information");
    const l = Number(s[1]), u = new Float32Array(l ** 3 * 4), f = new L(0, 0, 0), h = new L(1, 1, 1);
    if (s = r.exec(e), s !== null && f.set(Number(s[1]), Number(s[2]), Number(s[3])), s = a.exec(e), s !== null && h.set(Number(s[1]), Number(s[2]), Number(s[3])), f.x > h.x || f.y > h.y || f.z > h.z)
      throw f.set(0, 0, 0), h.set(1, 1, 1), new Error("Invalid input domain");
    let d = 0;
    for (; (s = n.exec(e)) !== null; )
      u[d++] = Number(s[1]), u[d++] = Number(s[2]), u[d++] = Number(s[3]), u[d++] = 1;
    const v = new Ne(u, l);
  ...
  load(e = () => {
    ...
    const i = this.manager, r = new pe();
    return new Promise((a, n) => {
      const s = new Image(), o = new Image();
      r.onError = (l) => {
        i.itemError(l), t !== null ? (t(`Failed to load ${l}`), a()) : n(`Failed to load ${l}`);
      }, r.onLoad = () => {
        const l = [s, o];
        e(l), a(l);
...
}, ks = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
vUv=uv;
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, Mi = class extends w {
  /**
   ...
   */
  get worldDistanceThreshold() {
    return -de(Number(this.defines.DISTANCE_THRESHOLD), this.near, this.far);
  }
  set worldDistanceThreshold(e) {
    const t = le(-e, this.near, this.far);
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`, Bi = class extends w {
  /**
...
#endif
#include <dithering_fragment>
}`, Ks = "uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}", Pi = class extends w {
  /**
   ...
   */
  setShaderParts(e) {
    return this.fragmentShader = Ys.replace(B.FRAGMENT_HEAD, e.get(B.FRAGMENT_HEAD) || "").replace(B.FRAGMENT_MAIN_UV, e.get(B.FRAGMENT_MAIN_UV) || "").replace(B.FRAGMENT_MAIN_IMAGE, e.get(B.FRAGMENT_MAIN_IMAGE) || ""), this.vertexShader = Ks.replace(B.VERTEX_HEAD, e.get(B.VERTEX_HEAD) || "").replace(B.VERTEX_MAIN_SUPPORT, e.get(B.VERTEX_MAIN_SUPPORT) || ""), this.needsUpdate = !0, this;
  }
  /**
...
}, Xs = `#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`, Zs = "uniform vec2 texelSize;uniform vec2 direction;uniform float scale;varying vec2 vOffset;varying vec2 vUv;void main(){vOffset=direction*texelSize*scale;vUv=position.xy*0.5+0.5;gl_Position=vec4(position.xy,1.0,1.0);}", Ii = class extends w {
  /**
   * Constructs a new convolution material.
   *
   * @param {Object} [options] - The options.
   ...
   */
  generateKernel(e) {
    const t = new ai(e), i = t.linearSteps, r = new Float64Array(i * 2);
    for (let a = 0, n = 0; a < i; ++a)
      r[n++] = t.linearOffsets[a], r[n++] = t.linearWeights[a];
    this.uniforms.kernel.value = r, this.defines.STEPS = i.toFixed(0), this.needsUpdate = !0;
  }
  /**
   * Sets the size of this object.
   *
  ...
  constructor({
    ...
    bilateral: i = !1,
    resolutionScale: r = 1,
    resolutionX: a = x.AUTO_SIZE,
    resolutionY: n = x.AUTO_SIZE
  } = {}) {
    super("BoxBlurPass"), this.needsDepthTexture = i, this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = new T(1, 1, { depthBuffer: !1 }), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Mi({ bilateral: i, kernelSize: e }), this.copyMaterial = new He();
    const s = this.resolution = new x(this, a, n, r);
   ...
   */
  render(e, t, i, r, a) {
    const n = this.scene, s = this.camera, o = this.renderTargetA, l = this.renderTargetB, u = this.blurMaterial;
    this.fullscreenMaterial = u;
    let f = t;
    for (let h = 0, d = Math.max(this.iterations, 1); h < d; ++h) {
      const v = (h & 1) === 0 ? o : l;
      u.inputBuffer = f.texture, e.setRenderTarget(v), e.render(n, s), f = v;
    }
    this.copyMaterial.inputBuffer = f.texture, this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : i), e.render(n, s);
  }
  /**
   * Updates the size of this pass.
   *
   ...
   */
  initialize(e, t, i) {
    e !== null && (this.blurMaterial.maxVaryingVectors = e.capabilities.maxVaryings), i !== void 0 && (this.renderTargetA.texture.type = i, this.renderTargetB.texture.type = i, i !== Y ? this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1" : e !== null && e.outputColorSpace === y && (this.renderTargetA.texture.colorSpace = y, this.renderTargetB.texture.colorSpace = y));
  }
}, wt = class extends H {
  /**
   ...
   */
  constructor({ depthPacking: e = ae } = {}) {
    super("DepthCopyPass");
    const t = new Bi();
    t.outputDepthPacking = e, this.fullscreenMaterial = t, this.needsDepthTexture = !0, this.needsSwap = !1, this.renderTarget = new T(1, 1, {
      type: e === ae ? Y : J,
      minFilter: P,
      magFilter: P,
      depthBuffer: !1
...
}, Js = Number(be.replace(/\D+/g, "")), ve = 255 / 256, qs = new Float32Array([
  ve / 256 ** 3,
  ve / 256 ** 2,
  ve / 256,
  ve
...
function $s(e) {
  const t = Js >= 167 ? _s : qs;
  return (e[0] * t[0] + e[1] * t[1] + e[2] * t[2] + e[3] * t[3]) / 255;
}
var en = class extends wt {
  /**
   ...
   */
  constructor({ depthPacking: e = ae, mode: t = ye.SINGLE } = {}) {
    if (e !== ae && e !== W)
   ...
   */
  render(e, t, i, r, a) {
    const n = this.fullscreenMaterial, s = n.mode;
    if (s === ye.FULL && super.render(e), this.callback !== null) {
      const o = this.renderTarget, l = this.pixelBuffer, u = o.texture.type !== J;
      let f = 0, h = 0;
      if (s === ye.SINGLE)
        super.render(e);
      else {
      ...
      e.readRenderTargetPixels(o, f, h, 1, 1, l), this.callback(u ? $s(l) : l[0]), this.callback = null;
    }
  }
  /**
   * Updates the size of this pass.
   ...
   */
  setSize(e, t) {
    this.fullscreenMaterial.mode === ye.FULL && super.setSize(e, t);
  }
};
function Gt(e, t, i) {
  for (const r of t) {
    const a = "$1" + e + r.charAt(0).toUpperCase() + r.slice(1), n = new RegExp("([^\\.])(\\b" + r + "\\b)", "g");
...
function tn(e, t, i) {
  ...
  if (s && (i.attributes & V.CONVOLUTION) !== 0)
    ...
    throw new Error(`Could not find mainImage or mainUv function (${t.name})`);
  {
    ...
    let u = l.get(B.FRAGMENT_HEAD) || "", f = l.get(B.FRAGMENT_MAIN_UV) || "", h = l.get(B.FRAGMENT_MAIN_IMAGE) || "", d = l.get(B.VERTEX_HEAD) || "", v = l.get(B.VERTEX_MAIN_SUPPORT) || "";
    const A = /* @__PURE__ */ new Set(), m = /* @__PURE__ */ new Set();
    if (s && (f += `	${e}MainUv(UV);
`, i.uvTransformation = !0), a !== null && /mainSupport/.test(a)) {
      const E = /mainSupport *\([\w\s]*?uv\s*?\)/.test(a);
      v += `	${e}MainSupport(`, v += E ? `vUv);
` : `);
`;
      for (const D of a.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))
        for (const K of D[1].split(/\s*,\s*/))
          i.varyings.add(K), A.add(K), m.add(K);
      for (const D of a.matchAll(o))
        m.add(D[1]);
    }
    for (const E of r.matchAll(o))
      m.add(E[1]);
    for (const E of t.defines.keys())
      m.add(E.replace(/\([\w\s,]*\)/g, ""));
    for (const E of t.uniforms.keys())
      m.add(E);
    m.delete("while"), m.delete("for"), m.delete("if"), t.uniforms.forEach((E, D) => i.uniforms.set(e + D.charAt(0).toUpperCase() + D.slice(1), E)), t.defines.forEach((E, D) => i.defines.set(e + D.charAt(0).toUpperCase() + D.slice(1), E));
    const S = /* @__PURE__ */ new Map([["fragment", r], ["vertex", a]]);
    Gt(e, m, i.defines), Gt(e, m, S), r = S.get("fragment"), a = S.get("vertex");
    const C = t.blendMode;
    if (i.blendModes.set(C.blendFunction, C), n) {
      t.inputColorSpace !== null && t.inputColorSpace !== i.colorSpace && (h += t.inputColorSpace === y ? `color0 = sRGBTransferOETF(color0);
	...
	`), t.outputColorSpace !== tt ? i.colorSpace = t.outputColorSpace : t.inputColorSpace !== null && (i.colorSpace = t.inputColorSpace);
      ...
      h += `${e}MainImage(color0, UV, `, (i.attributes & V.DEPTH) !== 0 && E.test(r) && (h += "depth, ", i.readDepth = !0), h += `color1);
	`;
      const D = e + "BlendOpacity";
      i.uniforms.set(D, C.opacity), h += `color0 = blend${C.blendFunction}(color0, color1, ${D});
...
`;
    ...
    if (u += r + `
`, a !== null && (d += a + `
`), l.set(B.FRAGMENT_HEAD, u), l.set(B.FRAGMENT_MAIN_UV, f), l.set(B.FRAGMENT_MAIN_IMAGE, h), l.set(B.VERTEX_HEAD, d), l.set(B.VERTEX_MAIN_SUPPORT, v), t.extensions !== null)
...
var rn = class extends H {
   ...
   */
  constructor(e, ...t) {
    super("EffectPass"), this.fullscreenMaterial = new Pi(null, null, null, e), this.listener = (i) => this.handleEvent(i), this.effects = [], this.setEffects(t), this.skipRendering = !1, this.minTime = 1, this.maxTime = Number.POSITIVE_INFINITY, this.timeScale = 1;
  }
  set mainScene(e) {
  ...
  updateMaterial() {
    ...
    for (const s of this.effects)
      if (s.blendMode.blendFunction === g.DST)
        e.attributes |= s.getAttributes() & V.DEPTH;
      else {
        if ((e.attributes & s.getAttributes() & V.CONVOLUTION) !== 0)
...
`;
    (e.attributes & V.DEPTH) !== 0 ? (e.readDepth && (r = `float depth = readDepth(UV);

	` + r), this.needsDepthTexture = this.getDepthTexture() === null) : this.needsDepthTexture = !1, e.colorSpace === y && (r += `color0 = sRGBToLinear(color0);
	`), e.uvTransformation ? (a = `vec2 transformedUv = vUv;
` + a, e.defines.set("UV", "transformedUv")) : e.defines.set("UV", "vUv"), e.shaderParts.set(B.FRAGMENT_HEAD, i), e.shaderParts.set(B.FRAGMENT_MAIN_IMAGE, r), e.shaderParts.set(B.FRAGMENT_MAIN_UV, a);
    for (const [s, o] of e.shaderParts)
      o !== null && e.shaderParts.set(s, o.trim().replace(/^#/, `
#`));
  ...
  initialize(e, t, i) {
    ...
    for (const r of this.effects)
      r.initialize(e, t, i);
    this.updateMaterial(), i !== void 0 && i !== Y && (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1");
  }
  /**
  ...
  constructor({
    ...
    iterations: t = 1,
    resolutionScale: i = 1,
    resolutionX: r = x.AUTO_SIZE,
    resolutionY: a = x.AUTO_SIZE
  } = {}) {
    super("GaussianBlurPass"), this.renderTargetA = new T(1, 1, { depthBuffer: !1 }), this.renderTargetA.texture.name = "Blur.Target.A", this.renderTargetB = this.renderTargetA.clone(), this.renderTargetB.texture.name = "Blur.Target.B", this.blurMaterial = new Ii({ kernelSize: e }), this.copyMaterial = new He(), this.copyMaterial.inputBuffer = this.renderTargetB.texture;
    const n = this.resolution = new x(this, r, a, i);
  ...
  render(e, t, i, r, a) {
    ...
    let f = t;
    for (let h = 0, d = Math.max(this.iterations, 1); h < d; ++h)
      u.direction.set(1, 0), u.inputBuffer = f.texture, e.setRenderTarget(o), e.render(n, s), u.direction.set(0, 1), u.inputBuffer = o.texture, e.setRenderTarget(l), e.render(n, s), h === 0 && d > 1 && (f = l);
    this.fullscreenMaterial = this.copyMaterial, e.setRenderTarget(this.renderToScreen ? null : i), e.render(n, s);
  }
  /**
   * Updates the size of this pass.
   *
  ...
  constructor(e, t, {
    ...
    super("NormalPass"), this.needsSwap = !1, this.renderPass = new ze(e, t, new Qi());
    const l = this.renderPass;
    l.ignoreBackground = !0, l.skipShadowMapUpdate = !0;
    const u = l.getClearPass();
    u.overrideClearColor = new N(7829503), u.overrideClearAlpha = 1, this.renderTarget = i, this.renderTarget === void 0 && (this.renderTarget = new T(1, 1, {
      minFilter: P,
      magFilter: P
...
function We(e, t, i, r) {
  const a = i[0] - t[0], n = i[1] - t[1], s = i[2] - t[2], o = e[0] - t[0], l = e[1] - t[1], u = e[2] - t[2], f = n * u - s * l, h = s * o - a * u, d = a * l - n * o, v = Math.sqrt(f * f + h * h + d * d), A = v * 0.5, m = f / v, S = h / v, C = d / v, E = -(e[0] * m + e[1] * S + e[2] * C), D = r[0] * m + r[1] * S + r[2] * C;
  return Math.abs(D + E) * A / 3;
}
...
function on(e, t, i, r, a, n) {
  const s = i * (t - 1), o = r * (t - 1), l = a * (t - 1), u = Math.floor(s), f = Math.floor(o), h = Math.floor(l), d = Math.ceil(s), v = Math.ceil(o), A = Math.ceil(l), m = s - u, S = o - f, C = l - h;
  if (u === s && f === o && h === l)
    Fe(e, t, s, o, l, n);
  else {
    let E;
    m >= S && S >= C ? E = De[0] : m >= C && C >= S ? E = De[1] : C >= m && m >= S ? E = De[2] : S >= m && m >= C ? E = De[3] : S >= C && C >= m ? E = De[4] : C >= S && S >= m && (E = De[5]);
    const [D, K, ee, ie] = E, re = kt[0];
    re[0] = m, re[1] = S, re[2] = C;
    const F = kt[1], Ae = d - u, xe = v - f, ne = A - h;
    F[0] = Ae * D[0] + u, F[1] = xe * D[1] + f, F[2] = ne * D[2] + h, Fe(e, t, F[0], F[1], F[2], U[0]), F[0] = Ae * K[0] + u, F[1] = xe * K[1] + f, F[2] = ne * K[2] + h, Fe(e, t, F[0], F[1], F[2], U[1]), F[0] = Ae * ee[0] + u, F[1] = xe * ee[1] + f, F[2] = ne * ee[2] + h, Fe(e, t, F[0], F[1], F[2], U[2]), F[0] = Ae * ie[0] + u, F[1] = xe * ie[1] + f, F[2] = ne * ie[2] + h, Fe(e, t, F[0], F[1], F[2], U[3]);
    const fe = We(K, ee, ie, re) * 6, k = We(D, ee, ie, re) * 6, Ge = We(D, K, ie, re) * 6, at = We(D, K, ee, re) * 6;
    U[0][0] *= fe, U[0][1] *= fe, U[0][2] *= fe, U[1][0] *= k, U[1][1] *= k, U[1][2] *= k, U[2][0] *= Ge, U[2][1] *= Ge, U[2][2] *= Ge, U[3][0] *= at, U[3][1] *= at, U[3][2] *= at, n[0] = U[0][0] + U[1][0] + U[2][0] + U[3][0], n[1] = U[0][1] + U[1][1] + U[2][1] + U[3][1], n[2] = U[0][2] + U[1][2] + U[2][2] + U[3][2];
  }
}
var ln = class {
  /**
   ...
   */
  static expand(e, t) {
    const i = Math.cbrt(e.length / 4), r = new Float32Array(3), a = new e.constructor(t ** 3 * 4), n = e instanceof Uint8Array ? 255 : 1, s = t ** 2, o = 1 / (t - 1);
    for (let l = 0; l < t; ++l)
      for (let u = 0; u < t; ++u)
        for (let f = 0; f < t; ++f) {
          const h = f * o, d = u * o, v = l * o, A = Math.round(f + u * t + l * s) * 4;
          on(e, i, h, d, v, r), a[A + 0] = r[0], a[A + 1] = r[1], a[A + 2] = r[2], a[A + 3] = n;
        }
    return a;
  }
}, Ie = [
  new Float32Array(2),
  new Float32Array(2)
], we = 16, ct = 20, Te = 30, un = 32, ft = new Float32Array([
  0,
  -0.25,
  0.25,
  -0.125,
...
function Vt(e) {
  const t = Ie[0], i = Ie[1], r = Math.sqrt(t[0] * 2) * 0.5, a = Math.sqrt(t[1] * 2) * 0.5, n = Math.sqrt(i[0] * 2) * 0.5, s = Math.sqrt(i[1] * 2) * 0.5, o = fn(e / un);
  t[0] = Ye(r, t[0], o), t[1] = Ye(a, t[1], o), i[0] = Ye(n, i[0], o), i[1] = Ye(s, i[1], o);
}
function Q(e, t, i, r, a, n) {
  const s = i - e, o = r - t, l = a, u = a + 1, f = t + o * (l - e) / s, h = t + o * (u - e) / s;
  if (l >= e && l < i || u > e && u <= i)
...
function hn(e, t, i, r, a) {
  const n = Ie[0], s = Ie[1], o = 0.5 + r, l = 0.5 + r - 1, u = t + i + 1;
  switch (e) {
    case 0: {
      a[0] = 0, a[1] = 0;
      break;
    ...
    case 1: {
      t <= i ? Q(0, l, u / 2, 0, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 2: {
      t >= i ? Q(u / 2, 0, u, l, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 3: {
      Q(0, l, u / 2, 0, t, n), Q(u / 2, 0, u, l, t, s), Vt(u), a[0] = n[0] + s[0], a[1] = n[1] + s[1];
      break;
    }
    case 4: {
      t <= i ? Q(0, o, u / 2, 0, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 5: {
      a[0] = 0, a[1] = 0;
    ...
    case 6: {
      Math.abs(r) > 0 ? (Q(0, o, u, l, t, n), Q(0, o, u / 2, 0, t, s), Q(u / 2, 0, u, l, t, a), s[0] = s[0] + a[0], s[1] = s[1] + a[1], a[0] = (n[0] + s[0]) / 2, a[1] = (n[1] + s[1]) / 2) : Q(0, o, u, l, t, a);
      break;
    }
    case 7: {
      Q(0, o, u, l, t, a);
    ...
    case 8: {
      t >= i ? Q(u / 2, 0, u, o, t, a) : (a[0] = 0, a[1] = 0);
      break;
    }
    case 9: {
      Math.abs(r) > 0 ? (Q(0, l, u, o, t, n), Q(0, l, u / 2, 0, t, s), Q(u / 2, 0, u, o, t, a), s[0] = s[0] + a[0], s[1] = s[1] + a[1], a[0] = (n[0] + s[0]) / 2, a[1] = (n[1] + s[1]) / 2) : Q(0, l, u, o, t, a);
      break;
    }
    case 10: {
      a[0] = 0, a[1] = 0;
    ...
    case 12: {
      Q(0, o, u / 2, 0, t, n), Q(u / 2, 0, u, o, t, s), Vt(u), a[0] = n[0] + s[0], a[1] = n[1] + s[1];
      break;
    }
    case 13: {
      Q(0, l, u, o, t, a);
...
function Wt(e, t, i, r, a, n) {
  let s = 0;
  for (let o = 0; o < Te; ++o)
    for (let l = 0; l < Te; ++l) {
      const u = l / (Te - 1), f = o / (Te - 1);
      dn(e, t, i, r, a + u, n + f) && ++s;
    }
  return s / (Te * Te);
}
function b(e, t, i, r, a, n, s, o) {
  const l = Ri[e], u = l[0], f = l[1];
  return u > 0 && (t += s[0], i += s[1]), f > 0 && (r += s[0], a += s[1]), o[0] = 1 - Wt(t, i, r, a, 1 + n, 0 + n), o[1] = Wt(t, i, r, a, 1 + n, 1 + n), o;
}
function vn(e, t, i, r, a) {
  const n = Ie[0], s = Ie[1], o = t + i + 1;
  switch (e) {
    case 0: {
...
function Yt(e, t, i) {
  ...
  for (let a = 0, n = e.length; a < n; ++a) {
    ...
    for (let u = 0; u < l; ++u)
      for (let f = 0; f < l; ++f) {
        i ? hn(a, f, u, t, r) : vn(a, f, u, t, r);
        const h = (u * l + f) * 2;
        o[h] = r[0] * 255, o[h + 1] = r[1] * 255;
      }
  }
}
function Kt(e, t, i, r, a, n, s) {
  const o = s.data, l = s.width;
  for (let u = 0, f = i.length; u < f; ++u) {
    const h = r[u], d = i[u], v = d.data, A = d.width;
    for (let m = 0; m < a; ++m)
      for (let S = 0; S < a; ++S) {
        const C = h[0] * a + e + S, D = ((h[1] * a + t + m) * l + C) * 4, K = n ? (m * m * A + S * S) * 2 : (m * A + S) * 2;
        o[D] = v[K], o[D + 1] = v[K + 1], o[D + 2] = 0, o[D + 3] = 255;
      }
  }
}
var pn = class {
   ...
   */
  static generate() {
    const e = 10 * we, t = ft.length * 5 * we, i = new Uint8ClampedArray(e * t * 4), r = new ue(e, t, i), a = Math.pow(we - 1, 2) + 1, n = ct, s = [], o = [];
    ...
    for (let l = 0; l < 16; ++l)
      s.push(new ue(
        ...
        n,
        n,
        new Uint8ClampedArray(n * n * 2),
        2
      ));
    for (let l = 0, u = ft.length; l < u; ++l)
      Yt(s, ft[l], !0), Kt(
        0,
        5 * we * l,
        s,
...
var An = class {
  ...
  generate() {
    ...
    return (t[0] !== null && t[1] !== null ? Promise.resolve(t) : mn(e)).then((r) => new Promise((a, n) => {
      const s = new Image(), o = new Image(), l = new pe();
      l.onLoad = () => a([s, o]), l.onError = n, s.addEventListener("error", (u) => l.itemError("smaa-search")), o.addEventListener("error", (u) => l.itemError("smaa-area")), s.addEventListener("load", () => l.itemEnd("smaa-search")), o.addEventListener("load", () => l.itemEnd("smaa-area")), l.itemStart("smaa-search"), l.itemStart("smaa-area"), s.src = r[0], o.src = r[1];
    }));
  }
}, Ke = /* @__PURE__ */ new Map([
  [X(0, 0, 0, 0), new Float32Array([0, 0, 0, 0])],
  [X(0, 0, 0, 1), new Float32Array([0, 0, 0, 1])],
  [X(0, 0, 1, 0), new Float32Array([0, 0, 1, 0])],
  [X(0, 0, 1, 1), new Float32Array([0, 0, 1, 1])],
  [X(0, 1, 0, 0), new Float32Array([0, 1, 0, 0])],
  [X(0, 1, 0, 1), new Float32Array([0, 1, 0, 1])],
  [X(0, 1, 1, 0), new Float32Array([0, 1, 1, 0])],
  [X(0, 1, 1, 1), new Float32Array([0, 1, 1, 1])],
  [X(1, 0, 0, 0), new Float32Array([1, 0, 0, 0])],
  [X(1, 0, 0, 1), new Float32Array([1, 0, 0, 1])],
  [X(1, 0, 1, 0), new Float32Array([1, 0, 1, 0])],
  [X(1, 0, 1, 1), new Float32Array([1, 0, 1, 1])],
  [X(1, 1, 0, 0), new Float32Array([1, 1, 0, 0])],
  [X(1, 1, 0, 1), new Float32Array([1, 1, 0, 1])],
  [X(1, 1, 1, 0), new Float32Array([1, 1, 1, 0])],
  [X(1, 1, 1, 1), new Float32Array([1, 1, 1, 1])]
]);
function ht(e, t, i) {
  return e + (t - e) * i;
}
  ...
  static generate() {
    ...
    for (let o = 0; o < 33; ++o)
      for (let l = 0; l < 66; ++l) {
        ...
        if (Ke.has(u) && Ke.has(f)) {
          const h = Ke.get(u), d = Ke.get(f), v = o * 66 + l;
          n[v] = 127 * xn(h, d), n[v + 33] = 127 * Dn(h, d);
        }
      }
    for (let o = 0, l = 17; l < 33; ++l)
      for (let u = 0; u < 64; ++u, o += 4)
        s[o] = n[l * 66 + u], s[o + 3] = 255;
    return new ue(64, 16, s);
  }
};
const bn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ASCIIEffect: Yr,
  ASCIITexture: ni,
  AdaptiveLuminanceMaterial: Ci,
  AdaptiveLuminancePass: yi,
  BlendFunction: g,
  BlendMode: si,
  BloomEffect: fi,
  BlurPass: ge,
  ...
  CopyMaterial: He,
  CopyPass: _e,
  DepthComparisonMaterial: Ai,
  DepthCopyMaterial: Bi,
  DepthCopyMode: ye,
  DepthCopyPass: wt,
  DepthDownsamplingMaterial: wi,
  DepthDownsamplingPass: Ti,
  DepthEffect: da,
  DepthMaskMaterial: Mt,
  DepthOfFieldEffect: Aa,
  DepthPass: Pt,
  DepthPickingPass: en,
  DepthSavePass: wt,
  DepthTestStrategy: Be,
  Disposable: ir,
  DotScreenEffect: Da,
  DownsamplingMaterial: li,
  EdgeDetectionMaterial: At,
  EdgeDetectionMode: Bt,
  Effect: I,
  EffectAttribute: V,
  EffectComposer: nr,
  EffectMaterial: Pi,
  ...
  FXAAEffect: Ea,
  GammaCorrectionEffect: Ca,
  GaussKernel: ai,
  GaussianBlurMaterial: Ii,
  GaussianBlurPass: an,
  GlitchEffect: Ba,
  GlitchMode: Ee,
  GodRaysEffect: ba,
  ...
  Resizer: x,
  Resolution: x,
  SMAAAreaImageData: pn,
  SMAAEffect: As,
  SMAAImageGenerator: An,
  SMAAImageLoader: Gs,
  SMAAPreset: Se,
  SMAASearchImageData: wn,
  SMAAWeightsMaterial: xi,
  SSAOEffect: Ss,
  SSAOMaterial: Di,
  SavePass: _e,
  ScanlineEffect: as,
  Section: B,
  Selection: St,
  SelectiveBloomEffect: us,
  SepiaEffect: fs,
  ShaderPass: q,
  ShockWaveEffect: ls,
  TetrahedralUpscaler: ln,
  TextureEffect: Ms,
  TiltShiftBlurMaterial: Ei,
  TiltShiftBlurPass: Si,
  TiltShiftEffect: bs,
  Timer: ei,
  ToneMappingEffect: Ls,
  ToneMappingMode: j,
  UpsamplingMaterial: ui,
  VignetteEffect: Ns,
  VignetteTechnique: Ce,
  WebGLExtension: Va,
  version: tr
...
class Tn extends $t {
  ...
  constructor() {
    super(), this.setAttribute("position", new qe(new Float32Array([
      -1,
      -1,
      3,
      -1,
      -1,
      3
    ]), 2)), this.setAttribute("uv", new qe(new Float32Array([
      0,
      0,
      2,
      0,
...
const En = /* @__PURE__ */ new Tn(), Sn = /* @__PURE__ */ new _i();
class _ {
  constructor(t) {
    this._mesh = new Jt(En, t), this._mesh.frustumCulled = !1;
  }
  render(t) {
    t.render(this._mesh, Sn);
  }
  get material() {
...
const Mn = parseInt(be.replace(/\D+/g, "")), Ni = Mn >= 162 ? class extends T {
  ...
  constructor(e = 1, t = 1, i = 1, r = {}) {
    ...
    this.texture = [];
    for (let n = 0; n < i; n++)
      this.texture[n] = a.clone(), this.texture[n].isRenderTargetTexture = !0;
  }
  setSize(e, t, i = 1) {
    if (this.width !== e || this.height !== t || this.depth !== i) {
      this.width = e, this.height = t, this.depth = i;
      for (let r = 0, a = this.texture.length; r < a; r++)
...
function Hi(e, t, i) {
  if (t.getQueryParameter(e, t.QUERY_RESULT_AVAILABLE)) {
    const n = t.getQueryParameter(e, t.QUERY_RESULT) / 1e6;
    i.lastTime = i.lastTime === 0 ? n : i.timeRollingAverage * i.lastTime + (1 - i.timeRollingAverage) * n;
  } else
    setTimeout(() => {
      Hi(e, t, i);
    }, 1);
...
class Bn extends H {
   ...
   */
  constructor(t, i, r = 512, a = 512) {
    super(), this.width = r, this.height = a, this.clear = !0, this.camera = i, this.scene = t, this.autosetGamma = !0, this.configuration = new Proxy({
      aoSamples: 16,
      aoRadius: 5,
      aoTones: 0,
      denoiseSamples: 8,
      ...
      set: (n, s, o) => {
        const l = n[s];
        return n[s] = o, o.equals ? o.equals(l) || this.firstFrame() : l !== o && this.firstFrame(), s === "aoSamples" && l !== o && this.configureAOPass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "denoiseSamples" && l !== o && this.configureDenoisePass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "halfRes" && l !== o && (this.configureAOPass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), this.configureHalfResTargets(), this.configureEffectCompositer(this.configuration.depthBufferType, this.camera.isOrthographicCamera), this.setSize(this.width, this.height)), s === "depthAwareUpsampling" && l !== o && this.configureEffectCompositer(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "gammaCorrection" && (this.autosetGamma = !1), s === "transparencyAware" && l !== o && (this.autoDetectTransparency = !1, this.configureTransparencyTarget()), !0;
      }
    }), this.samples = [], this.samplesDenoise = [], this.autoDetectTransparency = !0, this.frames = 0, this.lastViewMatrix = new O(), this.lastProjectionMatrix = new O(), this.configureEffectCompositer(this.configuration.depthBufferType), this.configureSampleDependentPasses(), this.configureHalfResTargets(), this.detectTransparency(), this.configureTransparencyTarget(), this.copyQuad = new _(new w({
      uniforms: {
        tDiffuse: {
          value: null
        }
      ...
      fragmentShader: `
            ...
            `
    })), this.writeTargetInternal = new T(this.width, this.height, {
      minFilter: R,
      magFilter: R,
      depthBuffer: !1,
      format: z
    }), this.readTargetInternal = new T(this.width, this.height, {
      minFilter: R,
      magFilter: R,
      depthBuffer: !1,
      format: z
    }), this.outputTargetInternal = new T(this.width, this.height, {
      minFilter: R,
      magFilter: R,
      depthBuffer: !1
    }), this.accumulationRenderTarget = new T(this.width, this.height, {
      minFilter: R,
      magFilter: R,
      depthBuffer: !1,
      format: z,
      ...
      depthBuffer: !1,
      alpha: !0
    }), this.accumulationQuad = new _(new w({
      uniforms: {
        frame: {
          value: 0
        },
      ...
      fragmentShader: `
             ...
             uniform float frame;
                ...
                `
    })), this.bluenoise = new it(Oi, 128, 128), this.bluenoise.colorSpace = tt, this.bluenoise.wrapS = se, this.bluenoise.wrapT = se, this.bluenoise.minFilter = P, this.bluenoise.magFilter = P, this.bluenoise.needsUpdate = !0, this.lastTime = 0, this.timeRollingAverage = 0.99, this.needsDepthTexture = !0, this.needsSwap = !0, this._r = new p(), this._c = new N();
  }
  configureHalfResTargets() {
    this.firstFrame(), this.configuration.halfRes ? (this.depthDownsampleTarget = new Ni(this.width / 2, this.height / 2, 2), this.depthDownsampleTarget.textures[0].format = rt, this.depthDownsampleTarget.textures[0].type = J, this.depthDownsampleTarget.textures[0].minFilter = P, this.depthDownsampleTarget.textures[0].magFilter = P, this.depthDownsampleTarget.textures[0].depthBuffer = !1, this.depthDownsampleTarget.textures[1].format = z, this.depthDownsampleTarget.textures[1].type = $, this.depthDownsampleTarget.textures[1].minFilter = P, this.depthDownsampleTarget.textures[1].magFilter = P, this.depthDownsampleTarget.textures[1].depthBuffer = !1, this.depthDownsampleQuad = new _(new w(Li))) : (this.depthDownsampleTarget && (this.depthDownsampleTarget.dispose(), this.depthDownsampleTarget = null), this.depthDownsampleQuad && (this.depthDownsampleQuad.dispose(), this.depthDownsampleQuad = null));
  }
  detectTransparency() {
    if (this.autoDetectTransparency) {
      let t = !1;
      this.scene.traverse((i) => {
        i.material && i.material.transparent && (t = !0);
      }), t && (this.configuration.transparencyAware = !0);
    }
  }
  configureTransparencyTarget() {
    this.configuration.transparencyAware ? (this.transparencyRenderTargetDWFalse = new T(this.width, this.height, {
      minFilter: R,
      magFilter: P,
      type: $,
      format: z
    }), this.transparencyRenderTargetDWTrue = new T(this.width, this.height, {
      minFilter: R,
      magFilter: P,
      type: $,
      format: z
    }), this.transparencyRenderTargetDWTrue.depthTexture = new Me(this.width, this.height, Oe), this.depthCopyPass = new _(new w({
      uniforms: {
        depthTexture: {
  ...
  renderTransparency(t) {
    const i = this.scene.background, r = t.getClearColor(new N()), a = t.getClearAlpha(), n = /* @__PURE__ */ new Map(), s = t.autoClearDepth;
    this.scene.traverse((o) => {
      n.set(o, o.visible);
    }), this.scene.background = null, t.autoClearDepth = !1, t.setClearColor(new N(0, 0, 0), 0), this.depthCopyPass.material.uniforms.depthTexture.value = this.depthTexture, this.depthCopyPass.material.uniforms.reverseDepthBuffer.value = this.configuration.depthBufferType === M.Reverse, t.setRenderTarget(this.transparencyRenderTargetDWFalse), this.scene.traverse((o) => {
      ...
      o.visible = n.get(o);
    }), t.setClearColor(r, a), this.scene.background = i, t.autoClearDepth = s;
  }
...
` + r.fragmentShader), this.effectShaderQuad ? (this.effectShaderQuad.material.dispose(), this.effectShaderQuad.material = new w(r)) : this.effectShaderQuad = new _(new w(r));
  }
...
` + r.fragmentShader : t === M.Reverse && (r.fragmentShader = `#define REVERSEDEPTH
` + r.fragmentShader), i && (r.fragmentShader = `#define ORTHO
` + r.fragmentShader), this.poissonBlurQuad ? (this.poissonBlurQuad.material.dispose(), this.poissonBlurQuad.material = new w(r)) : this.poissonBlurQuad = new _(new w(r));
  }
...
` + r.fragmentShader), this.effectCompositerQuad ? (this.effectCompositerQuad.material.dispose(), this.effectCompositerQuad.material = new w(r)) : this.effectCompositerQuad = new _(new w(r));
  }
  /**
       * 
       * @param {Number} n 
  ...
  generateHemisphereSamples(t) {
    const i = [];
    for (let r = 0; r < t; r++) {
      const a = 2.399963 * r, n = Math.sqrt(r + 0.5) / Math.sqrt(t), s = n * Math.cos(a), o = n * Math.sin(a), l = Math.sqrt(1 - (s * s + o * o));
      i.push(new L(s, o, l));
    }
    return i;
  }
  /**
       ...
       */
  generateDenoiseSamples(t, i) {
    const r = 2 * Math.PI * i / t, a = 1 / t, n = a, s = [];
    let o = a, l = 0;
    for (let u = 0; u < t; u++)
      s.push(new p(Math.cos(l), Math.sin(l)).multiplyScalar(Math.pow(o, 0.75))), o += n, l += r;
    return s;
  }
  setSize(t, i) {
    this.firstFrame(), this.width = t, this.height = i;
    const r = this.configuration.halfRes ? 0.5 : 1;
    this.writeTargetInternal.setSize(t * r, i * r), this.readTargetInternal.setSize(t * r, i * r), this.accumulationRenderTarget.setSize(t * r, i * r), this.configuration.halfRes && this.depthDownsampleTarget.setSize(t * r, i * r), this.configuration.transparencyAware && (this.transparencyRenderTargetDWFalse.setSize(t, i), this.transparencyRenderTargetDWTrue.setSize(t, i)), this.outputTargetInternal.setSize(t, i);
  }
  setDepthTexture(t) {
    this.depthTexture = t;
  }
...
class Pn extends er {
   ...
   */
  constructor(t, i, r = 512, a = 512) {
    super(), this.width = r, this.height = a, this.clear = !0, this.camera = i, this.scene = t, this.configuration = new Proxy({
      aoSamples: 16,
      aoRadius: 5,
      aoTones: 0,
      denoiseSamples: 8,
      ...
      set: (n, s, o) => {
        const l = n[s];
        return n[s] = o, o.equals ? o.equals(l) || this.firstFrame() : l !== o && this.firstFrame(), s === "aoSamples" && l !== o && this.configureAOPass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "denoiseSamples" && l !== o && this.configureDenoisePass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "halfRes" && l !== o && (this.configureAOPass(this.configuration.depthBufferType, this.camera.isOrthographicCamera), this.configureHalfResTargets(), this.configureEffectCompositer(this.configuration.depthBufferType, this.camera.isOrthographicCamera), this.setSize(this.width, this.height)), s === "depthAwareUpsampling" && l !== o && this.configureEffectCompositer(this.configuration.depthBufferType, this.camera.isOrthographicCamera), s === "transparencyAware" && l !== o && (this.autoDetectTransparency = !1, this.configureTransparencyTarget()), s === "stencil" && l !== o && (this.beautyRenderTarget.dispose(), this.beautyRenderTarget = new T(this.width, this.height, {
          minFilter: R,
          magFilter: P,
          type: $,
          format: z,
          stencilBuffer: o
        }), this.beautyRenderTarget.depthTexture = new Me(this.width, this.height, o ? Zt : Oe), this.beautyRenderTarget.depthTexture.format = o ? Xt : Rt), !0;
      }
    }), this.samples = [], this.samplesDenoise = [], this.autoDetectTransparency = !0, this.frame = 0, this.lastViewMatrix = new O(), this.lastProjectionMatrix = new O(), this.beautyRenderTarget = new T(this.width, this.height, {
      minFilter: R,
      magFilter: P,
      type: $,
      format: z,
      stencilBuffer: !1
    }), this.beautyRenderTarget.depthTexture = new Me(this.width, this.height, Oe), this.beautyRenderTarget.depthTexture.format = Rt, this.configureEffectCompositer(this.configuration.depthBufferType, this.camera.isOrthographicCamera), this.configureSampleDependentPasses(), this.configureHalfResTargets(), this.detectTransparency(), this.configureTransparencyTarget(), this.writeTargetInternal = new T(this.width, this.height, {
      minFilter: R,
      magFilter: R,
      depthBuffer: !1,
      format: z
      ...
      depthBuffer: !1,
      alpha: !0
    }), this.bluenoise = new it(Oi, 128, 128), this.accumulationQuad = new _(new w({
      uniforms: {
        frame: {
          value: 0
        },
      ...
      fragmentShader: `
             ...
             uniform float frame;
                ...
                `
    })), this.bluenoise.colorSpace = tt, this.bluenoise.wrapS = se, this.bluenoise.wrapT = se, this.bluenoise.minFilter = P, this.bluenoise.magFilter = P, this.bluenoise.needsUpdate = !0, this.lastTime = 0, this.timeRollingAverage = 0.99, this._r = new p(), this._c = new N();
  }
  configureHalfResTargets() {
    if (this.firstFrame(), this.configuration.halfRes) {
      this.depthDownsampleTarget = new Ni(this.width / 2, this.height / 2, 2), this.depthDownsampleTarget.textures[0].format = rt, this.depthDownsampleTarget.textures[0].type = J, this.depthDownsampleTarget.textures[0].minFilter = P, this.depthDownsampleTarget.textures[0].magFilter = P, this.depthDownsampleTarget.textures[0].depthBuffer = !1, this.depthDownsampleTarget.textures[1].format = z, this.depthDownsampleTarget.textures[1].type = $, this.depthDownsampleTarget.textures[1].minFilter = P, this.depthDownsampleTarget.textures[1].magFilter = P, this.depthDownsampleTarget.textures[1].depthBuffer = !1;
      const t = {
        ...Li
      };
      this.configuration.depthBufferType === M.Reverse && (t.fragmentShader = `#define REVERSEDEPTH
` + t.fragmentShader), this.depthDownsampleQuad = new _(new w(t));
    } else
  ...
  renderTransparency(t) {
    ...
    this.scene.traverse((o) => {
      n.set(o, o.visible);
    }), this.scene.background = null, t.autoClearDepth = !1, t.setClearColor(new N(0, 0, 0), 0), this.depthCopyPass.material.uniforms.depthTexture.value = this.beautyRenderTarget.depthTexture, this.depthCopyPass.material.uniforms.reverseDepthBuffer.value = this.configuration.depthBufferType === M.Reverse, t.setRenderTarget(this.transparencyRenderTargetDWFalse), this.scene.traverse((o) => {
      o.material && (o.visible = n.get(o) && (o.material.transparent && !o.material.depthWrite && !o.userData.treatAsOpaque || !!o.userData.cannotReceiveAO));
    }), t.clear(!0, !0, !0), this.depthCopyPass.render(t), t.render(this.scene, this.camera), t.setRenderTarget(this.transparencyRenderTargetDWTrue), this.scene.traverse((o) => {
      o.material && (o.visible = n.get(o) && o.material.transparent && o.material.depthWrite && !o.userData.treatAsOpaque);
    }), t.clear(!0, !0, !0), this.depthCopyPass.render(t), t.render(this.scene, this.camera), this.scene.traverse((o) => {
...
` + r.fragmentShader), this.effectCompositerQuad ? (this.effectCompositerQuad.material.dispose(), this.effectCompositerQuad.material = new w(r)) : this.effectCompositerQuad = new _(new w(r));
  ...
  generateHemisphereSamples(t) {
    ...
    for (let r = 0; r < t; r++) {
      const a = 2.399963 * r;
      let n = Math.sqrt(r + 0.5) / Math.sqrt(t);
      const s = n * Math.cos(a), o = n * Math.sin(a), l = Math.sqrt(1 - (s * s + o * o));
      i.push(new L(s, o, l));
    }
    return i;
  }
  ...
  setSize(t, i) {
    this.firstFrame(), this.width = t, this.height = i;
    const r = this.configuration.halfRes ? 0.5 : 1;
    this.beautyRenderTarget.setSize(t, i), this.writeTargetInternal.setSize(t * r, i * r), this.readTargetInternal.setSize(t * r, i * r), this.accumulationRenderTarget.setSize(t * r, i * r), this.configuration.halfRes && this.depthDownsampleTarget.setSize(t * r, i * r), this.configuration.transparencyAware && (this.transparencyRenderTargetDWFalse.setSize(t, i), this.transparencyRenderTargetDWTrue.setSize(t, i));
  }
  firstFrame() {
    this.needsFrame = !0;
  }
