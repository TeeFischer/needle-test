...
export class BloomEffect extends PostProcessingEffect {
     ...
     * @default 0.9
     */
    threshold = new VolumeParameter(.9);
    /**
    ...
    init() {
        ...
        this.scatter.valueProcessor = (v) => v;
    }
    onCreateEffect() {
        let bloom;
...
], BloomEffect.prototype, "threshold", void 0);
__decorate([
    serializable(VolumeParameter)
], BloomEffect.prototype, "intensity", void 0);
__decorate([
    serializable(VolumeParameter)
], BloomEffect.prototype, "scatter", void 0);
