...
export class ContactShadows extends Behaviour {
    ...
    fitShadows(params = {}) {
        ...
        if (params.positionOffset) {
            if (params.positionOffset.x !== undefined)
                this.shadowsRoot.position.x += params.positionOffset.x;
            if (params.positionOffset.y !== undefined)
                this.shadowsRoot.position.y += params.positionOffset.y;
            if (params.positionOffset.z !== undefined)
                this.shadowsRoot.position.z += params.positionOffset.z;
        }
        if (params.scaleFactor) {
            if (params.scaleFactor.x !== undefined)
                this.shadowsRoot.scale.x *= params.scaleFactor.x;
            if (params.scaleFactor.y !== undefined)
                this.shadowsRoot.scale.y *= params.scaleFactor.y;
            if (params.scaleFactor.z !== undefined)
                this.shadowsRoot.scale.z *= params.scaleFactor.z;
        }
        this.applyMinSize();
