...
export class EventSystem extends Behaviour {
    ...
    */
    ...
    onPointerEvent = (pointerEvent) => {
        ...
        if (debug) {
            if (data.isDown)
                console.log("DOWN", { id: data.pointerId, hits: hits.length });
            else if (data.isUp)
                console.log("UP", { id: data.pointerId, hits: hits.length });
            if (data.isClick)
                console.log("CLICK", { id: data.pointerId, hits: hits.length });
        }
        if (hits) {
