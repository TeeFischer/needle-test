...
const _licenseCheckResultChangedCallbacks = [];
// This is modified by a bundler (e.g. vite)
// Do not edit manually
let NEEDLE_ENGINE_LICENSE_TYPE = "basic";
if (debug)
...
/** @internal */
export function onLicenseCheckResultChanged(cb) {
...
export let runtimeLicenseCheckPromise = undefined;
...
function insertNonCommercialUseHint(ctx) {
    const style = `
        position: relative;
        display: block;
...
async function sendUsageMessageToAnalyticsBackend(context) {
    ...
    if (licenseType === "pro") {
        ...
        if (debug)
            console.debug("Telemetry attribute: " + attribute);
    }
    try {
