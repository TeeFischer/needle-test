...
import { getTempQuaternion, logHierarchy } from "./engine_three_utils.js";
...
export function instantiate(instance, opts) {
    ...
    const components = [];
    const referencemap = {}; // used to resolve references on components to components on other gameobjects to their new counterpart
...
function onAssignComponent(source, target, _newObjectsMap) {
...
//     return clone;
// }
function resolveReferences(_newInstance, newObjectsMap) {
