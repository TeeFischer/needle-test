import { CubeCamera, Scene, WebGLCubeRenderTarget } from 'three';
...
/** @internal */
export function isNeedleXRSessionEventReceiver(script, mode) {
    if (script) {
        const i = script;
        if (i.onBeforeXR ||
            i.onEnterXR ||
...
/** @internal */
export function updateIsActive(obj, force = false) {
...
/** @internal */
export function registerPrewarmObject(obj, context) {
    if (!obj)
        return;
