...
export class NeedleXRSession {
    ...
    */
    ...
    disconnectInputSource(inputSource) {
        const handleRemove = (oldController, array) => {
    ...
    _camera;
    _cameraRenderParent = new Object3D().rotateY(Math.PI);
        ...
        if (this.context.mainCamera && this._customforward) {
            ...
            this._cameraRenderParent.add(this._camera);
            {
                ...
                if (this._camera instanceof PerspectiveCamera && Math.abs(this._camera.near - minNearPlane) > threshold) {
                    ...
                    if (debug)
                        console.debug(`Setting camera near plane to ${minNearPlane} (was ${this.originalCameraNearPlane}) to account for XR rendering scale`);
                }
            }
        }
    }
...
//# sourceMappingURL=NeedleXRSession.js.map