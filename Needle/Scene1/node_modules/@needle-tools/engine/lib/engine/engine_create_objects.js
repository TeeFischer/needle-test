...
import { BoxGeometry, BufferGeometry, Color, CylinderGeometry, DoubleSide, ExtrudeGeometry, Group, Mesh, MeshBasicMaterial, MeshStandardMaterial, PlaneGeometry, Shape, SphereGeometry, Sprite, SpriteMaterial, Vector2 } from "three";
...
function createBoxWithRoundedEdges(width, height, _depth, radius0, smoothness) {
    ...
    const geometry = new ExtrudeGeometry(shape, {
        ...
        UVGenerator: {
            ...
            generateSideWallUV: (_, vertices, indexA, indexB, indexC, indexD) => {
                const uvs = [];
