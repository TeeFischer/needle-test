import { LODsManager as _LODsManager, NEEDLE_progressive } from "@needle-tools/gltf-progressive";
...
export class LODsManager {
    ...
    static GLTF_PROGRESSIVE_LODSMANAGER_TYPE = _LODsManager;
    context;
    _lodsManager;
    _settings = {};
    /**
    ...
    set skinnedMeshAutoUpdateBoundsInterval(value) {
    ...
    /** @internal */
    onAfterUpdatedLOD(_renderer, _scene, camera, mesh, level) {
        if (debug)
...
//# sourceMappingURL=engine_lods.js.map