...
var ASCIIEffect = class extends Effect {
  ...
  constructor({
    ...
    super("ASCIIEffect", ascii_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["asciiTexture", new Uniform$1(null)],
        ["cellCount", new Uniform$1(new Vector4())],
        ["color", new Uniform$1(new Color())]
      ])
    });
    this._cellSize = -1;
...
var BokehEffect = class extends Effect {
  ...
  constructor({
    ...
    super("BokehEffect", bokeh_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new Uniform$1(focus)],
        ["dof", new Uniform$1(dof)],
        ["aperture", new Uniform$1(aperture)],
        ["maxBlur", new Uniform$1(maxBlur)]
      ])
    });
  }
};
...
var DotScreenEffect = class extends Effect {
  ...
  constructor({ blendFunction, angle = Math.PI * 0.5, scale = 1 } = {}) {
    super("DotScreenEffect", dot_screen_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["angle", new Uniform$1(new Vector2())],
        ["scale", new Uniform$1(scale)]
      ])
    });
    this.angle = angle;
  }
...
var GlitchEffect = class extends Effect {
  ...
  constructor({
    ...
    super("GlitchEffect", glitch_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["perturbationMap", new Uniform$1(null)],
        ["columns", new Uniform$1(columns)],
        ["active", new Uniform$1(false)],
        ["random", new Uniform$1(1)],
        ["seeds", new Uniform$1(new Vector2())],
        ["distortion", new Uniform$1(new Vector2())]
      ])
    });
...
var GodRaysMaterial = class extends ShaderMaterial {
  ...
  constructor(lightPosition) {
    super({
      ...
      uniforms: {
        inputBuffer: new Uniform$1(null),
        lightPosition: new Uniform$1(lightPosition),
        density: new Uniform$1(1),
        decay: new Uniform$1(1),
        weight: new Uniform$1(1),
        exposure: new Uniform$1(1),
        clampMax: new Uniform$1(1)
      },
      blending: NoBlending,
      toneMapped: false,
      depthWrite: false,
...
var GridEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.OVERLAY, scale = 1, lineWidth = 0 } = {}) {
    super("GridEffect", grid_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["scale", new Uniform$1(new Vector2())],
        ["lineWidth", new Uniform$1(lineWidth)]
      ])
    });
    this.resolution = new Vector2();
    this.s = 0;
...
var LensDistortionEffect = class extends Effect {
  ...
  constructor({
    ...
    super("LensDistortionEffect", lens_distortion_default, {
      uniforms: /* @__PURE__ */ new Map([
        ["distortion", new Uniform$1(distortion)],
        ["principalPoint", new Uniform$1(principalPoint)],
        ["focalLength", new Uniform$1(focalLength)],
        ["skew", new Uniform$1(skew)]
      ])
    });
  }
  /**
...
var LUT1DEffect = class extends Effect {
  ...
  constructor(lut, { blendFunction = BlendFunction.SRC } = {}) {
    super("LUT1DEffect", lut_1d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([["lut", new Uniform$1(null)]])
    });
    this.lut = lut;
  }
  /**
...
var LUT3DEffect = class extends Effect {
  ...
  constructor(lut, {
    ...
    super("LUT3DEffect", lut_3d_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["lut", new Uniform$1(null)],
        ["scale", new Uniform$1(new Vector3())],
        ["offset", new Uniform$1(new Vector3())],
        ["domainMin", new Uniform$1(null)],
        ["domainMax", new Uniform$1(null)]
      ])
    });
...
var OutlineEffect = class extends Effect {
  ...
  constructor(scene, camera, {
    ...
    super("OutlineEffect", outline_default3, {
      uniforms: /* @__PURE__ */ new Map([
        ["maskTexture", new Uniform$1(null)],
        ["edgeTexture", new Uniform$1(null)],
        ["edgeStrength", new Uniform$1(edgeStrength)],
        ["visibleEdgeColor", new Uniform$1(new Color(visibleEdgeColor))],
        ["hiddenEdgeColor", new Uniform$1(new Color(hiddenEdgeColor))],
        ["pulse", new Uniform$1(1)],
        ["patternScale", new Uniform$1(patternScale)],
        ["patternTexture", new Uniform$1(null)]
      ])
    });
  ...
  constructor({
    ...
    super("RealisticBokehEffect", realistic_bokeh_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["focus", new Uniform$1(focus)],
        ["focalLength", new Uniform$1(focalLength)],
        ["fStop", new Uniform$1(fStop)],
        ["luminanceThreshold", new Uniform$1(luminanceThreshold)],
        ["luminanceGain", new Uniform$1(luminanceGain)],
        ["bias", new Uniform$1(bias)],
        ["fringe", new Uniform$1(fringe)],
        ["maxBlur", new Uniform$1(maxBlur)],
        ["dof", new Uniform$1(null)]
      ])
    });
    this.rings = rings;
...
var ScanlineEffect = class extends Effect {
  ...
  constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
    super("ScanlineEffect", scanlines_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["count", new Uniform$1(0)],
        ["scrollSpeed", new Uniform$1(0)]
      ])
    });
    this.resolution = new Vector2();
    this.d = density;
...
var ShockWaveEffect = class extends Effect {
  ...
  constructor(camera, position = new Vector3(), {
    ...
    super("ShockWaveEffect", shock_wave_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["active", new Uniform$1(false)],
        ["center", new Uniform$1(new Vector2(0.5, 0.5))],
        ["cameraDistance", new Uniform$1(1)],
        ["size", new Uniform$1(1)],
        ["radius", new Uniform$1(-waveSize)],
        ["maxRadius", new Uniform$1(maxRadius)],
        ["waveSize", new Uniform$1(waveSize)],
        ["amplitude", new Uniform$1(amplitude)]
      ])
    });
...
var SepiaEffect = class extends Effect {
  ...
  constructor({ blendFunction, intensity = 1 } = {}) {
    super("SepiaEffect", sepia_default, {
      blendFunction,
      uniforms: /* @__PURE__ */ new Map([
        ["weightsR", new Uniform$1(new Vector3(0.393, 0.769, 0.189))],
        ["weightsG", new Uniform$1(new Vector3(0.349, 0.686, 0.168))],
        ["weightsB", new Uniform$1(new Vector3(0.272, 0.534, 0.131))]
      ])
    });
  }
  /**
  ...
  constructor({ blendFunction, texture = null, aspectCorrection = false } = {}) {
    super("TextureEffect", texture_default, {
      ...
      uniforms: /* @__PURE__ */ new Map([
        ["map", new Uniform$1(null)],
        ["scale", new Uniform$1(1)],
        ["uvTransform", new Uniform$1(null)]
      ])
    });
...
var DepthCopyMaterial = class extends ShaderMaterial {
  ...
  constructor() {
    super({
      ...
      uniforms: {
        depthBuffer: new Uniform$1(null),
        texelPosition: new Uniform$1(new Vector2())
      },
      blending: NoBlending,
      toneMapped: false,
      depthWrite: false,
  ...
  constructor({ kernelSize = 35 } = {}) {
    super({
      ...
      uniforms: {
        inputBuffer: new Uniform$1(null),
        texelSize: new Uniform$1(new Vector2()),
        direction: new Uniform$1(new Vector2()),
        kernel: new Uniform$1(null),
        scale: new Uniform$1(1)
      },
      blending: NoBlending,
      toneMapped: false,
...
postprocessing/build/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UZGZU5ZI.js.map
