...
// node_modules/@needle-tools/three-animation-pointer/src/GLTFLoaderAnimationPointer.js
var ANIMATION_TARGET_TYPE = {
  node: "node",
  material: "material",
  camera: "camera",
  light: "light"
};
var KHR_ANIMATION_POINTER = "KHR_animation_pointer";
var INTERPOLATION = {
...
var _animationPointerDebug = false;
var GLTFAnimationPointerExtension = class {
  ...
  loadAnimationTargetFromChannelWithAnimationPointer(animationChannel) {
    ...
    if (useExtension) {
      ...
      if ((_a = this.animationPointerResolver) == null ? void 0 : _a.resolvePath) {
...
// node_modules/@needle-tools/three-animation-pointer/src/index.js
var src_default = GLTFAnimationPointerExtension;
export {
  GLTFAnimationPointerExtension,
  src_default as default
};
//# sourceMappingURL=src-W55SZFAH.js.map
