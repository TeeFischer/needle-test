...
// node_modules/@needle-tools/engine/node_modules/three/examples/jsm/postprocessing/Pass.js
var Pass2 = class {
  constructor() {
    this.isPass = true;
    this.enabled = true;
...
var $87431ee93b037844$export$2489f9981ab0fa82 = class extends (0, Pass) {
  ...
  configureAOPass(depthBufferType = (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Default, ortho = false) {
    ...
    if (depthBufferType === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Log)
      e.fragmentShader = "#define LOGDEPTH\n" + e.fragmentShader;
    else if (depthBufferType === (0, $05f6997e4b65da14$export$ed4ee5d1e55474a5).Reverse)
...
var $05f6997e4b65da14$export$2d57db20b5eb5e0a = class extends (0, Pass2) {
  /**
   * 
   * @param {THREE.Scene} scene
   * @param {THREE.Camera} camera 
  ...
  configureHalfResTargets() {
    ...
    if (this.configuration.halfRes) {
      ...
      if (this.configuration.depthBufferType === $05f6997e4b65da14$export$ed4ee5d1e55474a5.Reverse)
        e.fragmentShader = "#define REVERSEDEPTH\n" + e.fragmentShader;
      this.depthDownsampleQuad = new (0, $e4ca8dcb0218f846$export$dcd670d73db751f5)(new ShaderMaterial(e));
    } else {
      if (this.depthDownsampleTarget) {
        this.depthDownsampleTarget.dispose();
        this.depthDownsampleTarget = null;
  ...
  configureAOPass(depthBufferType = $05f6997e4b65da14$export$ed4ee5d1e55474a5.Default, ortho = false) {
    ...
    e.fragmentShader = e.fragmentShader.replace("16", this.configuration.aoSamples).replace("16.0", this.configuration.aoSamples + ".0");
    if (depthBufferType === $05f6997e4b65da14$export$ed4ee5d1e55474a5.Log)
      e.fragmentShader = "#define LOGDEPTH\n" + e.fragmentShader;
    else if (depthBufferType === $05f6997e4b65da14$export$ed4ee5d1e55474a5.Reverse)
      e.fragmentShader = "#define REVERSEDEPTH\n" + e.fragmentShader;
    if (ortho)
      e.fragmentShader = "#define ORTHO\n" + e.fragmentShader;
    if (this.configuration.halfRes)
...
export {
  $05f6997e4b65da14$export$ed4ee5d1e55474a5 as DepthType,
  $05f6997e4b65da14$export$2d57db20b5eb5e0a as N8AOPass,
  $87431ee93b037844$export$2489f9981ab0fa82 as N8AOPostPass
};
//# sourceMappingURL=N8AO-IIQOE3WB.js.map
