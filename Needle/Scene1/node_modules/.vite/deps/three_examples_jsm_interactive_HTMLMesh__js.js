...
// node_modules/@needle-tools/engine/node_modules/three/examples/jsm/interactive/HTMLMesh.js
...
function html2canvas(element) {
  ...
  function drawElement(element2, style) {
    ...
    if (element2.nodeType === Node.TEXT_NODE) {
      ...
      context.drawImage(element2, x, y);
      context.restore();
      ...
      width = rect.width;
      height = rect.height;
      context.drawImage(element2, x, y, width, height);
    } else {
      const rect = element2.getBoundingClientRect();
      x = rect.left - offset.left - 0.5;
      y = rect.top - offset.top - 0.5;
...
//# sourceMappingURL=three_examples_jsm_interactive_HTMLMesh__js.js.map
